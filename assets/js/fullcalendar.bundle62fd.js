...
!(function(e, t) {
    ...
    function r(e, n, r) {
        ...
        return "string" == typeof r ? (i.innerHTML = r) : null != r && a(i, r), i;
    }
    ...
    function a(e, t) {
        for (var n = c(t), r = 0; r < n.length; r++) e.appendChild(n[r]);
    }
    ...
    function g(e, t) {
        for (
            var n = e instanceof HTMLElement ? [e] : e, r = [], i = 0; i < n.length; i++
        )
    ...
    function ve(e, t) {
        ...
        return (
            e.start && ((n = B(e.start)), r && r <= n && (r = _(n, 1))), { start: n, end: r }
        );
    }
    ...
    function xe(e, t, n) {
        ...
        for (var s in ((o = Te(o, function(e) {
            ...
            if (a.recurringDef) {
                ...
                for (
                    var c = 0,
                        u = be(a, l, t, n.dateEnv, n.pluginSystem.hooks.recurringTypes); c < u.length; c++
                ) {
                    var d = u[c],
                        p = Yt(s, { start: d, end: r.add(d, l) });
                    o[p.instanceId] = p;
                }
            }
        }
            ...
            return (
                ...
                (e.prototype.setDates = function(e, t, n) {
                    ...
                    if (s && (null == t || (r = i.createMarker(t))) && this._instance) {
                        ...
                        if (r) {
                            ...
                            (o.hasEnd = !1), this.mutate({ datesDelta: l, standardProps: o });
                    }
                }),
                ...
                Object.defineProperty(e.prototype, "source", {
                    get: function() {
                        ...
                        return e ?
                            new ct(this._calendar, this._calendar.state.eventSources[e]) :
                            null;
                    },
                    enumerable: !0,
                    configurable: !0,
    ...
    function dt(e, t, n, r) {
        var i = {},
            ...
            c = gt(e.defs, t);
        for (var u in e.defs) {
            "inverse-background" === (S = e.defs[u]).rendering &&
                (S.groupId ?
                    ((i[S.groupId] = []), s[S.groupId] || (s[S.groupId] = S)) :
                    (o[u] = []));
        }
        for (var d in e.instances) {
            ...
            v &&
                ("inverse-background" === S.rendering ?
                    ...
                    i[S.groupId].push(v) :
                    o[p.defId].push(v) :
                    ("background" === S.rendering ? a : l).push({
                        def: S,
                        ui: h,
                        instance: p,
                        range: v,
    ...
    function bt(e, t, n, r, i) {
        ...
        return (
            ...
            t.allDay && (l.range = { start: B(l.range.start), end: B(l.range.end) }),
                    ...
                    if (t && n === t.latestFetchId) {
                        var s = Pe(
                            (function(e, t, n) {
                                ...
                                return i && (e = _e(e, i)), r && (e = _e(e, r)), e;
                            })(i, t, o),
                            t.sourceId,
                            o
                        );
                        return r && (s = xe(s, r, o)), Ne(wt(e, t.sourceId), s);
                    }
                    return e;
                ...
                !(function(e, t, n, r) {
                    ...
                    for (var h in a) {
                        var f = a[h],
                            ...
                            v = l[f.defId],
                            m = s[f.defId];
                        if (!Mt(v.constraints, g, c, e.businessHours, t)) return !1;
                        var y = t.opt("eventOverlap");
                        for (var E in ("function" != typeof y && (y = null), d)) {
                            var S = d[E];
                            if (Fe(g, S.range)) {
                        ...
                        for (
                            var b = t.state.eventStore, D = 0, w = v.allows; D < w.length; D++
                        ) {
                            var T = w[D],
                                ...
                                M = void 0;
                            if (
                                ((M = R ? new ut(t, R, I) : new ut(t, m)), !T(t.buildDateSpanApi(C), M))
                            )
                                return !1;
                        }
                    }
            ...
            !(
                ...
                !(function(e, t, n, r) {
                    var i = e.eventStore,
                        ...
                        c = t.selectionConfig;
                    r && (c = r(c));
                    if (!Mt(c.constraints, l, i, e.businessHours, t)) return !1;
                    ...
                    for (var d in s) {
                        ...
                        if (Fe(l, p.range)) {
                            ...
                            if (u && !u(new ut(t, o[p.defId], p))) return !1;
                        }
                    }
    ...
    function Mt(e, t, n, r, i) {
        for (var o = 0, s = e; o < s.length; o++) {
            if (!xt(Pt(s[o], t, n, r, i), t)) return !1;
        }
        return !0;
    }
    ...
    function jt(e, t, n, r) {
        ...
        if (s)
            return (
                ((a = Wt(o, t, s.allDay, Boolean(s.duration), n)).recurringDef = {
                    typeId: s.typeId,
                    typeData: s.typeData,
                    duration: s.duration,
                }), { def: a, instance: null }
        ...
        var a,
            ...
            c = (function(e, t, n, r, i) {
                ...
                l && c && (c = B(c));
                s && ((d = s.marker), l && (d = B(d)), c && d <= c && (d = null));
                d
                    ?
                    (u = !0) :
                    i ||
                    ((u = n.opt("forceEventDuration") || !1),
                        (d = n.dateEnv.add(
                            c,
    ...
    function Wt(e, t, n, r, i) {
        ...
        (s.defId = String(Gt++)), (s.sourceId = t), (s.allDay = n), (s.hasEnd = r);
        for (
            var a = 0, l = i.pluginSystem.hooks.eventDefParsers; a < l.length; a++
        ) {
            var c = {};
            (0, l[a])(s, o, c), (o = c);
        }
        return (
            (s.extendedProps = Se(o, s.extendedProps || {})),
    ...
    function $t(e, t, n, r, i) {
        ...
        return (
            ...
            (r = r ?
                ...
                ""),
            (i = i || ""), !a && e.navLinks ?
            "<a" + r + ' data-goto="' + Ht(JSON.stringify(l)) + '">' + i + "</a>" :
            "<span" + r + ">" + i + "</span>"
        );
    }
    ...
    function en(e, t, n, r) {
        ...
        return (
            je(t.activeRange, e) ?
            (u.push("fc-" + H[e.getUTCDay()]),
                a.monthMode &&
                c.getMonth(e) !== c.getMonth(t.currentRange.start) &&
                u.push("fc-other-month"),
                (o = _((i = B(s.getNow())), 1)),
                e < i ?
                u.push("fc-past") :
                e >= o ?
                u.push("fc-future") :
                (u.push("fc-today"), !0 !== r && u.push(l.getClass("today")))) :
        ...
        rn = (function(e) {
            ...
            return (
                ...
                (t.prototype.off = function(e, t) {
                    return (
                        this._handlers && sn(this._handlers, e, t),
                ...
                (t.prototype.lockOverflow = function(e) {
                    ...
                    "auto" === t &&
                        ...
                        (n =
                            ...
                            "scroll" :
                            "hidden"),
                        m(this.el, { overflowX: t, overflowY: n });
                }),
    ...
    var vn = (function(e) {
        ...
        return (
            ...
            (t.prototype.isInteractionValid = function(e) {
                ...
                if (n)
                    for (var i in r)
                        if (!Ge(n.validRange, r[i].range)) return !1;
                return Ct(e, t);
            }),
            (t.prototype.isDateSelectionValid = function(e) {
                var t = this.context.calendar,
                    n = this.props.dateProfile;
                return (!(n && !Ge(n.validRange, e.range)) &&
                    (function(e, t) {
                        return Rt({ dateSelection: e }, t);
                    })(e, t)
                );
            }),
        ...
        recurringTypes: [{
            parse: function(e, t, n) {
                ...
                if (a) {
                    var c = null;
                    return (
                        "duration" in t && ((c = K(t.duration)), delete t.duration), !c &&
                        s.startTime &&
                        s.endTime &&
                        ((r = s.endTime),
                            (i = s.startTime),
            ...
            expand: function(e, t, n) {
                var r = Ae(t, { start: e.startRecur, end: e.endRecur });
                return r ?
                    (function(e, t, n, r) {
                        var i = e ? Re(e) : null,
                            o = B(n.start),
    ...
    function In(e, t, n) {
        for (
            var r = Ie(t.state.eventSources), i = [], o = 0, s = e; o < s.length; o++
        ) {
            ...
            (function(e, t) {
                var n = [].concat(e || []),
                    ...
                    (function(e, t) {
                        for (var n = 0; n < e.length; n++)
                            for (
                                var r = e[n].toLocaleLowerCase().split("-"), i = r.length; i > 0; i--
                            ) {
            ...
            return (
                ...
                (e.prototype.compute = function() {
                    var e = pe(
                        ...
                        i =
                        "rtl" === pe(this.dynamicOverrides.dir, this.overrides.dir, r.dir) ?
                        Pn :
                        {};
                    (this.dirDefaults = i),
            ...
            return (
                ...
                (e.prototype.toDate = function(e, t) {
                    return "local" === this.timeZone ?
                        ...
                        new Date(
                            e.valueOf() -
                            1e3 * this.namedTimeZoneImpl.offsetForArray(j(e)) * 60
                        ) :
    ...
    function Yn(e, t) {
        for (
            var n = t.pluginSystem.hooks.eventSourceDefs, r = n.length - 1; r >= 0; r--
        ) {
    ...
    function Qn(e, t, n) {
        var r = n.pluginSystem.hooks.eventSourceDefs[e.sourceDefId],
            i = String(Xn++);
        return (
            r.fetch({ eventSource: e, calendar: n, range: t },
                function(r) {
                    var o,
                        s,
                        a = r.rawEvents,
        ...
        return (
            ...
            (e.prototype.buildCurrentRangeInfo = function(e, t) {
                ...
                return (
                    ...
                    ((s = ne((o = this.getFallbackDuration())).unit),
                        (a = this.buildRangeFromDuration(e, t, o, s))), { duration: o, unit: s, range: a }
                );
            }),
            ...
            (e.prototype.adjustActiveRange = function(e, t, n) {
                ...
                return (
                    ...
                    (ee(t) < 0 && ((i = B(i)), (i = r.add(i, t))),
                        ee(n) > 1 && ((o = _((o = B(o)), -1)), (o = r.add(o, n)))), { start: i, end: o }
                );
            }),
            (e.prototype.buildRangeFromDuration = function(e, t, n, r) {
                ...
                function d() {
                    (s = c.startOf(e, u)), (a = c.add(s, n)), (l = { start: s, end: a });
                }
                return (
                    u ||
                    ((i = this.options.dateIncrement) ?
                        ((o = K(i)), (u = te(o) < te(n) ? ne(o, !Q(i)).unit : r)) :
                        (u = r)),
                    ee(n) <= 1 &&
                    this.isHiddenDay(s) &&
                    (s = B((s = this.skipHiddenDays(s, t)))),
                    d(),
    ...
    function er(e, t, n) {
        for (
            var r = (function(e, t) {
                ...
                i = (function(e, t, n, r, i) {
                    ...
                    switch (t.type) {
                        ...
                        case "NEXT":
                            ...
                            break;
                        case "SET_DATE":
                            (e.activeRange && je(e.currentRange, t.dateMarker)) ||
                    ...
                    return !o ||
                        ...
                        (e &&
                            ((a = e),
                                (l = o),
                                Ue(a.validRange, l.validRange) &&
                                Ue(a.activeRange, l.activeRange) &&
                                Ue(a.renderRange, l.renderRange) &&
                                $(a.minTime, l.minTime) &&
                                $(a.maxTime, l.maxTime))) ?
                        e :
                        o;
                ...
                a = 0,
                l = n.pluginSystem.hooks.reducers; a < l.length; a++
        ) {
            s = (0, l[a])(s, t, n);
        }
        return s;
    ...
    function tr(e, t, n) {
        switch (t.type) {
            ...
            case "SET_VIEW_TYPE":
                ...
                return n.activeRange && !je(n.activeRange, r) ?
    ...
    var ar = { start: null, end: null, allDay: Boolean };
    ...
    function gr(e, t) {
        ...
        return Ce(
            (function(e, t) {
                var n,
                    r = {};
                for (n in e) ur(n, r, e, t);
                for (n in t) ur(n, r, e, t);
                return r;
            })(n, r),
            function(e) {
                return (function(e, t, n) {
                    ...
                    return {
                        ...
                        buttonTextDefault: c(n.localeDefaults) ||
                            c(n.dirDefaults) ||
                    ...
                    return (
                        ...
                        t.split(" ").forEach(function(e, t) {
                            ...
                            if (
                                        ...
                                        "title" === e
                                            ...
                                            ((r = p[e]) ?
                                                ((d = function(e) {
                                                    ...
                                                    (g = s.getCustomButtonIconClass(r)) ||
                                                    (g = s.getIconClass(e)) ||
                                                    (v = r.text)) :
                                                (a = u[e]) ?
                                                (n.viewsWithButtons.push(e),
                                                    ...
                                                    (v = a.buttonTextOverride) ||
                                                    (g = s.getIconClass(e)) ||
                                                    (v = a.buttonTextDefault)) :
                                                l[e] &&
                                                ((d = function() {
                                                        l[e]();
                                                    }),
                                                    ...
                                                    (v = f[e])),
                                                d &&
                                                ((y = ["fc-" + e + "-button", s.getClass("button")]),
                                                    v ?
                                                    ((m = Ht(v)), (S = "")) :
                                                    g &&
                                                    ((m = "<span class='" + g + "'></span>"),
                                ...
                                c && g && r.classList.add(g), a(r, o), d.appendChild(r);
                            } else a(d, o);
                        }),
                        d
                    );
            ...
            return (
                ...
                (t.prototype._renderSkeleton = function(e) {
                    ...
                    for (
                        var t = e.calendar,
                            n = 0,
                            i = t.pluginSystem.hooks.viewContainerModifiers; n < i.length; n++
                    ) {
                ...
                (t.prototype.removeElClassNames = function() {
                    for (
                        var e = this.el.classList, t = 0, n = this.elClassNames; t < n.length; t++
                    ) {
                        var r = n[t];
                        e.remove(r);
                    }
                ...
                (t.prototype.updateElClassNames = function(e) {
                    ...
                    for (
                        var r = this.el.classList, i = 0, o = this.elClassNames; i < o.length; i++
                    ) {
                        var s = o[i];
                        r.add(s);
                    }
                ...
                (t.prototype._renderToolbars = function(e, t, n, r) {
                    ...
                    p
                        ?
                        (s ||
                            ((s = this.header = new vr("fc-header-toolbar")),
                                l(this.el, s.el)),
                            s.receiveProps(Se({ layout: p }, E), o)) :
                        s && (s.destroy(), (s = this.header = null)),
                        h ?
                        (c ||
                            ((c = this.footer = new vr("fc-footer-toolbar")),
                                a(this.el, c.el)),
                            c.receiveProps(Se({ layout: h }, E), o)) :
                        c && (c.destroy(), (c = this.footer = null));
                }),
                ...
                (t.prototype.renderView = function(e, t) {
                    ...
                    for (
                        var l = {
                            ...
                            c = 0,
                            u = this.buildViewPropTransformers(
                        ...
                        ((r = l.el),
                            ...
                            k(r, "mouseover", i, function(e, t) {
                                if (t !== a) {
                                    (a = t), o(e, t);
                                    var n = function(e) {
                                        (a = null), s(e, t), t.removeEventListener("mouseleave", n);
                                    };
        ...
        return (
            ...
            (e.prototype.dispatch = function(e) {
                if ((this.actionQueue.push(e), !this.isReducing)) {
                    ...
                    var n = this.state;
                    (this.isReducing = !1), !t.loadingLevel && n.loadingLevel ?
            ...
            (e.prototype.mutateOptions = function(e, t, n, r) {
                ...
                this.optionsManager.mutate(s, t, n),
                    ...
                    this.batchRendering(function() {
                        if (
                            (d ?
                                (c && i.dispatch({ type: "CHANGE_TIMEZONE", oldDateEnv: l }),
                                    i.dispatch({
                                        type: "SET_VIEW_TYPE",
            ...
            (e.prototype.buildDatePointApi = function(e) {
                for (
                    var t,
                        ...
                        r = {},
                        i = 0,
                        o = this.pluginSystem.hooks.datePointTransforms; i < o.length; i++
                ) {
                    var s = o[i];
                    Se(r, s(e, this));
                }
            ...
            (e.prototype.buildDateSpanApi = function(e) {
                for (
                    var t,
                        ...
                        r = {},
                        i = 0,
                        o = this.pluginSystem.hooks.dateSpanTransforms; i < o.length; i++
                ) {
                    var s = o[i];
                    Se(r, s(e, this));
                }
            ...
            (e.prototype.addEvent = function(e, t) {
                ...
                var i;
                if (t instanceof ct) i = t.internalEventSource.sourceId;
                else if (null != t) {
    ...
    var _r = (function(e) {
        function t(t, n) {
            ...
            return (
                ...
                (i.renderBusinessHoursMem = Xt(
                    ...
                    i.unrenderBusinessHours, [i.renderDatesMem]
                )),
                (i.renderDateSelectionMem = Xt(
                    i.renderDateSelectionWrap,
                    i.unrenderDateSelectionWrap, [i.renderDatesMem]
                )),
                ...
                (i.renderEventSelectionMem = Xt(
                    ...
                    i.unrenderEventSelectionWrap, [i.renderEventsMem]
                )),
                (i.renderEventDragMem = Xt(
                    i.renderEventDragWrap,
                    i.unrenderEventDragWrap, [i.renderDatesMem]
                )),
                (i.renderEventResizeMem = Xt(
                    i.renderEventResizeWrap,
                    i.unrenderEventResizeWrap, [i.renderDatesMem]
                )),
                (i.viewSpec = t),
                (i.type = t.type),
                n.appendChild(i.el),
        ...
        return (
            ...
            (t.prototype.renderDatesWrap = function(e) {
                this.renderDates(e),
                    this.addScroll({ duration: K(this.context.options.scrollTime) });
            }),
            ...
            (t.prototype.startNowIndicator = function(e, t) {
                ...
                s.options.nowIndicator &&
                    ...
                    ((r = this.updateNowIndicator.bind(this)),
                        ...
                        (i =
                            l.add(l.startOf(this.initialNowDate, n), K(1, n)).valueOf() -
    ...
    var zr = (function() {
            ...
            return (
                ...
                (e.prototype.unrender = function(e, t) {
                    ...
                    n && ("bgEvent" === e && yt(t, n, !1), this.detachSegs(e, n));
                }),
                (e.prototype.renderSegEls = function(e, t) {
                    var n,
                        r = this,
                ...
                (e.prototype.detachSegs = function(e, t) {
                    ...
                    n && (n.forEach(u), delete this.containerElsByType[e]);
                }),
                (e.prototype.computeSizes = function(e) {
    ...
    var Ar = { startTime: K, duration: K, create: Boolean, sourceId: String },
        Ur = { create: !0 };
    ...
    function Gr(e, t, n, r, i, o, s, a) {
        var l,
            ...
            h = ["fc-day-header", u.getClass("widgetHeader")];
        return (
            (l =
                "function" == typeof d.columnHeaderHtml ?
                d.columnHeaderHtml(c.toDate(e)) :
                "function" == typeof d.columnHeaderText ?
                Ht(d.columnHeaderText(c.toDate(e))) :
                Ht(c.format(e, i))),
            ...
            (a ? " " + a : "") +
            ">" +
            (p ? $t(d, c, { date: e, forceOff: !n || 1 === r }, l) : l) +
            "</th>"
        );
    }
    var jr = (function(e) {
        ...
        Yr = (function() {
            function e(e, t) {
                ...
                if (t) {
                    for (
                        r = o[0].getUTCDay(), n = 1; n < o.length && o[n].getUTCDay() !== r; n++
                    );
            ...
            return (
                (e.prototype.sliceProps = function(e, t, n, r, i) {
                    ...
                    var a = e.eventUiBases,
                        l = this.sliceEventStore.apply(
                            this, [e.eventStore, a, t, n, i].concat(o)
                        );
                    return {
                        dateSelectionSegs: this.sliceDateSelection.apply(
                            this, [e.dateSelection, a, i].concat(o)
                        ),
                        businessHourSegs: this.sliceBusinessHours.apply(
                            this, [e.businessHours, t, n, r, i].concat(o)
                        ),
                        fgEventSegs: l.fg,
                        bgEventSegs: l.bg,
                        eventDrag: this.sliceEventDrag.apply(
                            this, [e.eventDrag, a, t, n, i].concat(o)
                        ),
                        eventResize: this.sliceEventResize.apply(
                            this, [e.eventResize, a, t, n, i].concat(o)
                        ),
                        eventSelection: e.eventSelection,
                    };
                }),
                (e.prototype.sliceNowDate = function(e, t) {
                    ...
                    return this._sliceDateSpan.apply(
                        this, [{ range: { start: e, end: O(e, 1) }, allDay: !1 }, {}, t].concat(n)
                    );
                }),
                (e.prototype._sliceBusinessHours = function(e, t, n, r, i) {
                    ...
                    return e ?
                        this._sliceEventStore.apply(
                            this, [xe(e, Zr(t, Boolean(n)), r), {}, t, n, i].concat(o)
                        ).bg :
                        [];
                }),
                ...
                (e.prototype._sliceDateSpan = function(e, t, n) {
                    ...
                    if (!e) return [];
                    for (
                        var o = cr(e, t, n.context.calendar),
    ...
    (e.compensateScroll = function(e, t) {
        t.left && m(e, { borderLeftWidth: 1, marginLeft: t.left - 1 }),
            t.right && m(e, { borderRightWidth: 1, marginRight: t.right - 1 });
    }),
        ...
        re(e),
            e.forEach(function(t, n) {
                var c = n === e.length - 1 ? i : r,
                    ...
                    d = u + I(t);
                d < c ? (o.push(t), s.push(d), a.push(u)) : (l += d);
            }),
            n &&
            ((t -= l),
    ...
    (e.formatIsoTimeString = function(e) {
        return (
            ce(e.getUTCHours(), 2) +
            ":" +
            ce(e.getUTCMinutes(), 2) +
            ":" +
            ce(e.getUTCSeconds(), 2)
        );
    }),
    ...
    (e.preventSelection = function(e) {
        e.classList.add("fc-unselectable"), e.addEventListener("selectstart", P);
    }),
...
(function(e, t) {
            ...
            return (
                ...
                (n.prototype.buildRenderRange = function(n, r, i) {
                    ...
                    if (
                        (/^(year|month)$/.test(r) &&
                            ((l = s.startOfWeek(l)),
                                (o = s.startOfWeek(c)).valueOf() !== c.valueOf() &&
                                (c = t.addWeeks(o, 1))),
        ...
        s = (function() {
            ...
            return (
                ...
                (e.prototype.position = function() {
                    ...
                    t.applyStyle(i, { top: e - s.top, left: n - s.left });
                }),
            ...
            return (
                ...
                (n.prototype.renderSegHtml = function(e, n) {
                    var r,
                        ...
                        l = s.ui,
                        c = a.allDay,
                        u = t.computeEventDraggable(o, a, l),
                        d = c && e.isStart && t.computeEventStartResizable(o, a, l),
                        p = c && e.isEnd && t.computeEventEndResizable(o, a, l),
                    ...
                    return (
                        ...
                        (g = '<span class="fc-time">' + t.htmlEscape(r) + "</span>"),
                        (i =
                            '<span class="fc-title">' +
                ...
                (n.prototype.renderSegRow = function(e, n) {
                    ...
                    function E(e) {
                        for (; o < e;)
                            ...
                            ((c = document.createElement("td")), s.appendChild(c)),
                            (m[r][o] = c),
                            (y[r][o] = c),
                            o++;
                    }
    ...
    var d = (function(e) {
            ...
            return (
                ...
                (n.prototype.renderFillRow = function(e, n) {
                    var r,
                        ...
                        l = s.colCnt,
                        c = a ? l - 1 - n.lastCol : n.firstCol,
                        u = (a ? l - 1 - n.firstCol : n.lastCol) + 1;
                    ...
                    return (
                        d && (a ? t.appendToElement(o, d) : t.prependToElement(o, d)), i
                    );
                }),
                n
            );
        ...
        f = (function(e) {
            function n(n) {
                ...
                return (
                    (r.renderFgEvents = t.memoizeRendering(
                        i.renderSegs.bind(i),
                        i.unrender.bind(i), [o]
                    )),
                    (r.renderEventSelection = t.memoizeRendering(
                        i.selectByInstanceId.bind(i),
                        i.unselectByInstanceId.bind(i), [r.renderFgEvents]
                    )),
                    (r.renderEventDrag = t.memoizeRendering(
                        i.hideByHash.bind(i),
                        i.showByHash.bind(i), [o]
                    )),
                    (r.renderEventResize = t.memoizeRendering(
                        i.hideByHash.bind(i),
                        i.showByHash.bind(i), [o]
                    )),
                    r
    ...
    function m(e, n, r, i) {
        ...
        return (
            l.unshift("fc-day", s.getClass("widgetContent")),
            '<td class="' +
            l.join(" ") +
            '"' +
    ...
    var y = t.createFormatter({ day: "numeric" }),
        ...
        S = (function(e) {
            function n(n, r) {
                ...
                var a = (i.renderCells = t.memoizeRendering(
                    i._renderCells,
                    i._unrenderCells
                ));
                return (
            ...
            return (
                ...
                (n.prototype.getCellRange = function(e, n) {
                    ...
                    return { start: r, end: t.addDays(r, 1) };
                }),
                ...
                (n.prototype._renderCells = function(e, n) {
                    var r,
                        ...
                        d = this.colCnt,
                        p = "";
                    for (r = 0; r < u; r++) p += this.renderDayRowHtml(r, n);
                    for (
                        this.el.innerHTML = p,
                ...
                (n.prototype.renderNumberCellsHtml = function(e) {
                    ...
                    return this.context.isRtl && r.reverse(), r.join("");
                }),
                (n.prototype.renderNumberCellHtml = function(e) {
                    ...
                    return c || this.renderProps.cellWeekNumbersVisible ?
                        ((n = t.getDayClasses(
                            ...
                            this.renderProps.cellWeekNumbersVisible &&
                            e.getUTCDay() === r &&
                            (a += t.buildGotoAnchorHtml(
                                s,
                                o, { date: e, type: "week" }, { class: "fc-week-number" },
                                o.format(e, E)
                            )),
                            c &&
                            (a += t.buildGotoAnchorHtml(
                ...
                (n.prototype.computeRowLevelLimit = function(e) {
                    ...
                    for (n = 0; n < o.length; n++)
                        if (
                            ((r = o[n]).classList.remove("fc-limited"),
                ...
                (n.prototype.limitRow = function(e, n) {
                    ...
                    if (n && n < b.segLevels.length) {
                        for (
                            r = b.segLevels[n - 1],
                            i = b.cellMatrix,
                            (o = t.findChildren(b.tbodyEl).slice(n)).forEach(function(
                                e
                            ) {
                            ...
                            if (c) {
                                for (
                                    p = (d = i[n - 1][C]).rowSpan || 1, h = [], f = 0; f < u.length; f++
                                )
                ...
                (n.prototype.unlimitRow = function(e) {
                    ...
                    n.moreEls &&
                        (n.moreEls.forEach(t.removeElement), (n.moreEls = null)),
                        n.limitedEls &&
                        (n.limitedEls.forEach(function(e) {
                ...
                (n.prototype.renderMoreLink = function(e, n, r) {
                    var i = this,
                        ...
                        c = o.options,
                        u = o.isRtl,
                        d = t.createElement("a", { className: "fc-more" });
                    return (
                        (d.innerText = this.getMoreLinkText(r.length)),
                ...
                (n.prototype.showSegPopover = function(e, n, r, i) {
                    ...
                    h
                        ?
                        (a.right = t.computeRect(v).right + 1) :
                        (a.left = t.computeRect(v).left - 1),
        ...
        D = (function(e) {
            function n() {
                ...
                return (
                    ...
                    (n.renderSkeleton = t.memoizeRendering(
                        n._renderSkeleton,
                        n._unrenderSkeleton
                    )),
                    (n.renderHeadIntroHtml = function() {
                        var e = n.context,
                            r = e.theme,
                            i = e.options;
                        return n.colWeekNumbersVisible ?
                            '<th class="fc-week-number ' +
                            r.getClass("widgetHeader") +
                            '" ' +
                            n.weekNumberStyleAttr() +
                            "><span>" +
                    ...
                    (n.renderDayGridNumberIntroHtml = function(e, r) {
                        ...
                        return n.colWeekNumbersVisible ?
                            ...
                            t.buildGotoAnchorHtml(
                                o,
                                s, { date: a, type: "week", forceOff: 1 === r.colCnt },
                                s.format(a, b)
                            ) +
                            "</td>" :
                            "";
            ...
            return (
                ...
                (n.prototype._renderSkeleton = function(e) {
                    ...
                    var r = t.createElement("div", { className: "fc-day-grid" });
                    n.appendChild(r),
                ...
                (n.prototype.updateBaseSize = function(e, n, r) {
                    var i,
                        o,
                        s = this.dayGrid,
                        a = this.context.options.eventLimit,
                ...
                (n.prototype.setGridHeight = function(e, n) {
                    this.context.options.monthMode ?
                        (n && (e *= this.dayGrid.rowCnt / 6),
                            t.distributeHeight(this.dayGrid.rowEls, e, !n)) :
                        n ?
    ...
    var w = (function(e) {
            function t(t) {
                ...
                return (n.slicer = new T()), (n.dayGrid = t), n;
            }
            return (
                r(t, e),
                        ...
                        n.receiveProps(
                            i({},
                                this.slicer.sliceProps(
                                    ...
                                    n,
                                    o
                                ), { dateProfile: r, cells: o.cells, isRigid: e.isRigid }
                            ),
                            t
                        );
                }),
        ...
        C = (function(e) {
            function n() {
                var n = (null !== e && e.apply(this, arguments)) || this;
                return (n.buildDayTable = t.memoize(R)), n;
            }
            return (
                r(n, e),
                (n.prototype.render = function(t, n) {
...
(function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ?
        ...
        "function" == typeof define && define.amd ?
        define(["exports", "@fullcalendar/core"], t) :
        t(((e = e || self).FullCalendarGoogleCalendar = {}), e.FullCalendar);
})(this, function(e, t) {
    "use strict";
    /*! *****************************************************************************
        Copyright (c) Microsoft Corporation.
    ...
    var n = function() {
        ...
        o = {
            parseMeta: function(e) {
                if (
                    ("string" == typeof e && (e = { url: e }), "object" == typeof e)
                ) {
                ...
                if (l) {
                    var c = (function(e) {
                        ...
                        u = (function(e, r, i, o) {
                            var s, a, l;
                            o.canComputeOffset ?
                                ((a = o.formatIso(e.start)), (l = o.formatIso(e.end))) :
                                ((a = t.addDays(e.start, -1).toISOString()),
    ...
    var s = t.createPlugin({ eventSourceDefs: [o] });
                ...
                (e.prototype.handleMove = function(e, t) {
                    if (this.isEnabled) {
                        ...
                        i < 0 ?
                            ...
                            this.isAnimating ||
                            ((this.isAnimating = !0), this.requestAnimation(f()));
                    }
                }),
                ...
                (e.prototype.computeBestEdge = function(e, t) {
                    for (
                        var n = this.edgeThreshold,
                            r = null,
                            i = 0,
                            o = this.scrollCaches; i < o.length; i++
                    ) {
                        var s = o[i],
                            a = s.clientRect,
                            l = e - a.left,
                        ...
                        l >= 0 &&
                            ...
                            (u <= n &&
                                ...
                                s.canScrollUp() &&
                                (!r || r.distance > u) &&
                                (r = { scrollCache: s, name: "top", distance: u }),
                                d <= n &&
                                this.everMovedDown &&
                                s.canScrollDown() &&
                                (!r || r.distance > d) &&
                                (r = { scrollCache: s, name: "bottom", distance: d }),
                                l <= n &&
                                this.everMovedLeft &&
                                s.canScrollLeft() &&
                                (!r || r.distance > l) &&
                                (r = { scrollCache: s, name: "left", distance: l }),
                                c <= n &&
                                this.everMovedRight &&
                                s.canScrollRight() &&
                                (!r || r.distance > c) &&
                                (r = { scrollCache: s, name: "right", distance: c }));
                    }
                    return r;
                }),
        ...
        m = (function() {
            ...
            return (
                ...
                (e.prototype.isWithinClipping = function(e, n) {
                    for (
                        var r, i, o = { left: e, top: n }, s = 0, a = this.scrollCaches; s < a.length; s++
                    ) {
                        var l = a[s];
                        if (
                            ((r = l.getEventTarget()),
                                ...
                                "HTML" !== (i = r.tagName) &&
                                "BODY" !== i &&
                                !t.pointInsideRect(o, l.clientRect))
                        )
                            return !1;
                    }
                    return !0;
                            ...
                            !v ||
                                (a.props.dateProfile &&
                                    !t.rangeContainsRange(
                                        a.props.dateProfile.activeRange,
                                        v.dateSpan.range
                                    )) ||
                                (o && !(v.layer > o.layer)) ||
                                ((v.rect.left += c),
                ...
                (r.handleDragEnd = function(e) {
                    ...
                    if (!r.dragging.pointer.wasTouchScroll) {
                        ...
                        s &&
                            a &&
                            E(s, a) &&
                            n.triggerDateClick(s.dateSpan, s.dayEl, i, e.origEvent);
                    }
                });
                var i = n.component;
                (r.dragging = new v(i.el)), (r.dragging.autoScroller.isEnabled = !1);
                var o = (r.hitDragging = new y(
                    r.dragging,
                ...
                (r.handleHitUpdate = function(e, n) {
                    ...
                    e &&
                        (((s = (function(e, n, r) {
                                ...
                                r.component.isDateSelectionValid(s)) ||
                            ((a = !0), (s = null))),
                        s ?
                        o.dispatch({ type: "SELECT_DATES", selection: s }) :
    ...
    var D = (function(e) {
        function n(r) {
            ...
            (o.handlePointerDown = function(e) {
                ...
                var p =
                    i.isValidSegDownEl(n) && !t.elementClosest(n, ".fc-resizer");
                s.setIgnoreMove(!p),
                    (o.isDragging =
                        p && e.subjectEl.classList.contains("fc-draggable"));
            }),
            (o.handleDragStart = function(e) {
                ...
                e.isTouch ?
                    s !== o.component.props.eventSelection &&
                    r.dispatch({ type: "SELECT_EVENT", eventInstanceId: s }) :
                    ...
                    if (e) {
                        ...
                        s === a || (h.editable && h.droppable) ?
                            (l = (function(e, n, r) {
                                ...
                                for (
                                    var u = { datesDelta: c, standardProps: l },
                                        d = 0,
                                        p = r; d < p.length; d++
                                ) {
                                    (0, p[d])(u, e, n);
                                ...
                                i,
                                e,
                                a.pluginSystem.hooks.eventDragMutationMassagers
                            )) &&
                            ((c = t.applyMutationToEventStore(r, a.eventUiBases, l, a)),
                                (d.mutatedEvents = c),
                                p.isInteractionValid(d) ||
                                ((u = !0),
                                    (l = null),
                                    (c = null),
                                    (d.mutatedEvents = t.createEmptyEventStore()))) :
                            (a = null);
                    }
                    o.displayDrag(a, d),
            ...
            (o.handleDragEnd = function(e) {
                if (o.isDragging) {
                    ...
                    if (
                        ...
                        if (l === r) {
                            r.dispatch({ type: "MERGE_EVENTS", eventStore: f });
                            for (
                                var v = {},
                                    m = 0,
                                    y = r.pluginSystem.hooks.eventDropTransformers; m < y.length; m++
                            ) {
                                var E = y[m];
                                i(v, E(c, r));
                            }
                            var S = i({}, v, {
                                ...
                                event: new t.EventApi(
                                    r,
                                    f.defs[u.defId],
                                    d ? f.instances[d.instanceId] : null
                                ),
                                revert: function() {
                            ...
                            r.publiclyTrigger("eventLeave", [
                                    { draggedEl: e.subjectEl, event: p, view: s },
                                ]),
                                r.dispatch({
    ...
    var w = (function(e) {
        function n(n) {
            ...
            (r.handlePointerDown = function(e) {
                ...
                r.dragging.setIgnoreMove(!r.component.isValidSegDownEl(e.origEvent.target) ||
                    (e.isTouch &&
            ...
            (r.handleHitUpdate = function(e, n, o) {
                ...
                e &&
                    ...
                    u &&
                    ((d = t.applyMutationToEventStore(a, s.eventUiBases, u, s)),
                        (h.mutatedEvents = d),
                        r.component.isInteractionValid(h) ||
                        ((p = !0), (u = null), (d = null), (h.mutatedEvents = null))),
                    d ?
                    s.dispatch({ type: "SET_EVENT_RESIZE", state: h }) :
            ...
            (r.handleDragEnd = function(e) {
                ...
                i.publiclyTrigger("eventResizeStop", [
                        { el: r.draggingSeg.el, event: l, jsEvent: e.origEvent, view: o },
                    ]),
                    r.validMutation ?
                    (i.dispatch({ type: "MERGE_EVENTS", eventStore: u }),
            ...
            function e(e) {
                ...
                (this.onDocumentPointerUp = function(e) {
                    ...
                    if (!o.wasTouchScroll) {
                        ...
                        s.eventSelection &&
                            !t.elementClosest(o.downEl, D.SELECTOR) &&
        ...
        C = (function() {
            function e(e, n) {
                ...
                (this.handleHitUpdate = function(e, n, o) {
                    ...
                    e &&
                        ((a = e.component.context.calendar),
                            r.canDropElOnCalendar(o.subjectEl, a) &&
                            ((l = (function(e, n, r) {
                                    for (
                                        var o = i({}, n.leftoverProps),
                                            s = 0,
                                            a = r.pluginSystem.hooks.externalDefTransforms; s < a.length; s++
                                    ) {
                                        var l = a[s];
                                        i(o, l(e, n));
                                    }
                                    ...
                                    e.allDay &&
                                        n.startTime &&
                                        (u = r.dateEnv.add(u, n.startTime));
                                    var d = n.duration ?
                                        r.dateEnv.add(u, n.duration) :
                                        r.getDefaultEventEnd(e.allDay, u),
                                        p = t.createEventInstance(c.defId, { start: u, end: d });
                                    return { def: c, instance: p };
                                })(e.dateSpan, r.dragMeta, a)),
                                (u.mutatedEvents = t.eventTupleToStore(l)),
                                (c = !t.isInteractionValid(u, a)) &&
                                ((u.mutatedEvents = t.createEmptyEventStore()),
                                    (l = null)))),
                        r.displayDrag(a, u),
        ...
        o = (function(e) {
            function n(n, r) {
                ...
                return (
                    (o.renderContent = t.memoizeRendering(
                        a.renderSegs.bind(a),
                        a.unrender.bind(a), [o.renderSkeleton]
                    )),
                    o
                );
            }
            return (
                ...
                (n.prototype._renderSkeleton = function(e) {
                    ...
                    for (
                        var r = 0, i = (n.getClass("listView") || "").split(" "); r < i.length; r++
                    ) {
                        var o = i[r];
                ...
                (n.prototype.eventRangeToSegs = function(e, n) {
                    var r,
                        ...
                        s = this.context,
                        a = s.dateEnv,
                        l = s.nextDayThreshold,
                        c = e.range,
                        u = e.def.allDay,
                        d = [];
                    for (r = 0; r < n.length; r++)
                        if (
                            (i = t.intersectRanges(c, n[r])) &&
                            ((o = {
                                    component: this,
                                    eventRange: e,
                                    start: i.start,
                                ...
                                !u &&
                                r + 1 < n.length &&
                                c.end < a.add(n[r + 1].start, l))
                        ) {
                            (o.end = c.end), (o.isEnd = !0);
                            break;
                        }
                    return d;
                }),
                    ...
                    return t.createElement(
                        ...
                        (s ?
                            t.buildGotoAnchorHtml(
                                o,
                                i,
                                e, { class: "fc-list-heading-main" },
                                t.htmlEscape(i.format(e, s))
                            ) :
                            "") +
                        (a ?
                            t.buildGotoAnchorHtml(
                                o,
                                i,
                                e, { class: "fc-list-heading-alt" },
                                t.htmlEscape(i.format(e, a))
                            ) :
                            "") +
                        "</td>"
                    );
...
(function(e, t) {
    ...
    var o = function() {
        ...
        s = (function(e) {
            ...
            return (
                ...
                (n.prototype.attachSegs = function(e, t) {
                    for (
                        var n = this.timeGrid.groupSegsByCol(e), r = 0; r < n.length; r++
                    )
                ...
                (n.prototype.renderSegHtml = function(e, n) {
                    var r,
                        ...
                        l = s.ui,
                        c = a.allDay,
                        u = t.computeEventDraggable(this.context, a, l),
                        d = e.isStart && t.computeEventStartResizable(this.context, a, l),
                        p = e.isEnd && t.computeEventEndResizable(this.context, a, l),
                        h = this.getSegClasses(e, u, d || p, n),
                        f = t.cssToStr(this.getSkinCss(l));
                        ...
                        ((function(e) {
                                ...
                                for (t = 0; t < e.length; t++)
                                    for (n = e[t], r = 0; r < n.length; r++)
                                        for (
                                            (i = n[r]).forwardSegs = [], o = t + 1; o < e.length; o++
                                        )
                                ...
                                (t = (function(e) {
                                    ...
                                    for (t = 0; t < e.length; t++) {
                                        for (
                                            n = e[t], r = 0; r < i.length && l(n, i[r]).length; r++
                                        );
                ...
                (n.prototype.assignSegCss = function(e) {
                    for (var n = 0, r = e; n < r.length; n++) {
                        ...
                        t.applyStyle(i.el, this.generateSegCss(i)),
                            ...
                            i.eventRange.def.title &&
                            i.bottom - i.top < 30 &&
                            i.el.classList.add("fc-short");
                    }
                }),
    ...
    function a(e) {
        ...
        if (void 0 === e.forwardPressure) {
            for (t = 0; t < r.length; t++)
                a((n = r[t])), (i = Math.max(i, 1 + n.forwardPressure));
            e.forwardPressure = i;
        }
    }
    ...
    function c(e) {
        ...
        return (
            (n.forwardPressure = e.forwardPressure),
    ...
    var u = (function(e) {
        ...
        h = (function(e) {
            function r(n, r) {
                ...
                (i.renderColumns = t.memoizeRendering(
                    i._renderColumns,
                    i._unrenderColumns, [i.renderSkeleton]
                )),
                (i.renderProps = r);
                ...
                return (
                    (i.mirrorRenderer = new u(i)),
                    (i.renderBusinessHours = t.memoizeRendering(
                        l.renderSegs.bind(l, "businessHours"),
                        l.unrender.bind(l, "businessHours"), [o]
                    )),
                    (i.renderDateSelection = t.memoizeRendering(
                        i._renderDateSelection,
                        i._unrenderDateSelection, [o]
                    )),
                    (i.renderFgEvents = t.memoizeRendering(
                        a.renderSegs.bind(a),
                        a.unrender.bind(a), [o]
                    ...
                    (i.renderBgEvents = t.memoizeRendering(
                        ...
                        l.unrender.bind(l, "bgEvent"), [o]
                    )),
                    (i.renderEventSelection = t.memoizeRendering(
                        a.selectByInstanceId.bind(a),
                        a.unselectByInstanceId.bind(a), [i.renderFgEvents]
                    )),
                    (i.renderEventDrag = t.memoizeRendering(
                        i._renderEventDrag,
                        i._unrenderEventDrag, [o]
                    )),
                    (i.renderEventResize = t.memoizeRendering(
                        i._renderEventResize,
                        i._unrenderEventResize, [o]
                    )),
                    i
                );
            }
            return (
                ...
                (r.prototype._processOptions = function(e) {
                    ...
                    null === (n = t.wholeDivideDurations(i, o)) && ((o = i), (n = 1)),
                        (this.slotDuration = i),
                        (this.snapDuration = o),
                        (this.snapsPerSlot = n),
                        (r = e.slotLabelFormat),
                ...
                (r.prototype.renderSlatRowHtml = function(e) {
                    for (
                        var n,
                            ...
                            l = o.isRtl,
                            c = "",
                            u = t.startOfDay(e.renderRange.start),
                            d = e.minTime,
                            p = t.createDuration(0); t.asRoughMs(d) < t.asRoughMs(e.maxTime);
                        ...
                        (i =
                            ...
                            (r ?
                                "<span>" +
                                t.htmlEscape(s.format(n, this.labelFormat)) +
                                "</span>" :
                                "") +
                            "</td>"),
                        (c +=
                            '<tr data-time="' +
                            t.formatIsoTimeString(n) +
                            '"' +
                            (r ? "" : ' class="fc-minor"') +
                            ">" +
                            (l ? "" : i) +
                ...
                (r.prototype._renderColumns = function(e, r) {
                    ...
                    for (var d = 0; d < this.colCnt; d++)
                        o.publiclyTrigger("dayRender", [
                            { date: c.toDate(e[d].date), el: this.colEls[d], view: s },
                        ]);
                ...
                (r.prototype.computeSegVerticals = function(e) {
                    var t,
                        n,
                        r,
                        i = this.context.options.timeGridEventMinHeight;
                    for (t = 0; t < e.length; t++)
                        (n = e[t]),
                ...
                (r.prototype.assignSegVerticals = function(e) {
                    ...
                    for (n = 0; n < e.length; n++)
                        (r = e[n]), t.applyStyle(r.el, this.generateSegVerticalCss(r));
                }),
                    ...
                    if (null != l && null != c) {
                        var u = s.tops[c],
                            ...
                            g = t.addDurations(
                                ...
                                t.multiplyDuration(this.snapDuration, h)
                            ),
                            v = r.add(f, g);
                        return {
                            col: l,
                            dateSpan: {
                                range: { start: v, end: r.add(v, this.snapDuration) },
                                allDay: !1,
                            },
                            dayEl: this.colEls[l],
                            relativeRect: {
        ...
        v = (function(e) {
                ...
                return (
                    ...
                    (n.renderHeadIntroHtml = function() {
                        var e,
                            ...
                            o = r.dateEnv,
                            s = r.options,
                            a = n.props.dateProfile.renderRange,
                        ...
                        return s.weekNumbers ?
                            ((e = o.format(a.start, g)),
                                ...
                                t.buildGotoAnchorHtml(
                                    s,
                                    o, { date: a.start, type: "week", forceOff: l > 1 },
                                    t.htmlEscape(e)
                                ) +
                                "</th>") :
                            '<th class="fc-axis ' +
                    ...
                    (n.renderTimeGridBgIntroHtml = function() {
                        return (
                            '<td class="fc-axis ' +
                            n.context.theme.getClass("widgetContent") +
                            '" ' +
                            n.axisStyleAttr() +
                            "></td>"
                        );
            ...
            return (
                ...
                (r.prototype.render = function(t, n) {
                    e.prototype.render.call(this, t, n), this.renderSkeleton(n);
                }),
                (r.prototype.destroy = function() {
                    e.prototype.destroy.call(this), this.renderSkeleton.unrender();
                }),
                (r.prototype._renderSkeleton = function(e) {
                    ...
                    var i = t.createElement("div", { className: "fc-time-grid" });
                    if (
                        (r.appendChild(i),
                    ...
                    if (
                        ...
                        this.scroller.clear(),
                            ...
                            (this.dayGrid.removeSegPopover(),
                                (i = this.context.options.eventLimit) &&
                                "number" != typeof i &&
                                (i = 5),
    ...
    var m = (function(e) {
        ...
        return (
            ...
            (n.prototype.render = function(e, t) {
                ...
                a.receiveContext(t),
                    a.receiveProps(
                        o({}, this.slicer.sliceProps(e, r, null, t.calendar, a, s), {
                            dateProfile: r,
                            cells: i.cells[0],
                        }),
                        t
    ...
    var E = (function(e) {
        ...
        S = (function(e) {
            function r() {
                var n = (null !== e && e.apply(this, arguments)) || this;
                return (n.buildDayTable = t.memoize(b)), n;
            }
            return (
                i(r, e),
                (r.prototype.render = function(t, n) {
                    ...
                    this.header &&
                        ...
                        this.simpleTimeGrid.receiveProps(
                            o({}, c.timed, { dateProfile: i, dayTable: l }),
                            n
                        ),
                        this.simpleDayGrid &&
                        this.simpleDayGrid.receiveProps(
                ...
                (r.prototype._renderSkeleton = function(r) {
                    e.prototype._renderSkeleton.call(this, r),
                        ...
                        this.dayGrid &&
                        (this.simpleDayGrid = new n.SimpleDayGrid(this.dayGrid));
                }),
                (r.prototype._unrenderSkeleton = function() {
                    e.prototype._unrenderSkeleton.call(this),
                        this.header && this.header.destroy(),
