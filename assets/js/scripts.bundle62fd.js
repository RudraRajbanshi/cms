...
var KTApp = function() {
    var t = {},
        ...
        a = function() { $('[data-toggle="tooltip"]').each((function() { e($(this)) })) },
        n = function(t) {
            var e = t.data("skin") ? "popover-" + t.data("skin") : "",
                a = t.data("trigger") ? t.data("trigger") : "hover";
            t.popover({ trigger: a, template: '            <div class="popover ' + e + '" role="tooltip">                <div class="arrow"></div>                <h3 class="popover-header"></h3>                <div class="popover-body"></div>            </div>' })
        },
        i = function() { $('[data-toggle="popover"]').each((function() { n($(this)) })) },
        o = function(t, e) { t = $(t), new KTCard(t[0], e) },
        l = function() { $('[data-card="true"]').each((function() { var t = $(this);!0 !== t.data("data-card-initialized") && (o(t, {}), t.data("data-card-initialized", !0)) })) };
    return {
        init: function(e) { e && (t = e), KTApp.initComponents() },
        initComponents: function() {
            $('[data-scroll="true"]').each((function() {
                var t = $(this);
                KTUtil.scrollInit(this, { mobileNativeScroll: !0, handleWindowResize: !0, rememberPosition: "true" == t.data("remember-position") })
            })), a(), i(), $("body").on("click", "[data-close=alert]", (function() { $(this).closest(".alert").hide() })), $(".custom-file-input").on("change", (function() {
                var t = $(this).val();
        ...
        initPopovers: function() { i() },
        initPopover: function(t) { n(t) },
        initCard: function(t, e) { o(t, e) },
        initCards: function() { l() },
        initSticky: function() { initSticky() },
        initAbsoluteDropdown: function(t) {
            ! function(t) {
                var e;
                t && $("body").on("show.bs.dropdown", t, (function(t) { e = $(t.target).find(".dropdown-menu"), $("body").append(e.detach()), e.css("display", "block"), e.position({ my: "right top", at: "right bottom", of: $(t.relatedTarget) }) })).on("hide.bs.dropdown", t, (function(t) { $(t.target).append(e.detach()), e.hide() }))
            }(t)
        },
        block: function(t, e) {
            var a, n = $(t),
                i = '<span class="spinner ' + ((e = $.extend(!0, { opacity: .05, overlayColor: "#000000", type: "", size: "", state: "primary", centerX: !0, centerY: !0, message: "", shadow: !0, width: "auto" }, e)).type ? "spinner-" + e.type : "") + " " + (e.state ? "spinner-" + e.state : "") + " " + (e.size ? "spinner-" + e.size : "") + '"></span';
            ...
            var l = { message: a, centerY: e.centerY, centerX: e.centerX, css: { top: "30%", left: "50%", border: "0", padding: "0", backgroundColor: "none", width: e.width }, overlayCSS: { backgroundColor: e.overlayColor, opacity: e.opacity, cursor: "wait", zIndex: "body" == t ? 1100 : 10 }, onUnblock: function() { n && n[0] && (KTUtil.css(n[0], "position", ""), KTUtil.css(n[0], "zoom", "")) } };
            "body" == t ? (l.css.top = "50%", $.blockUI(l)) : (n = $(t)).block(l)
        },
        unblock: function(t) { t && "body" != t ? $(t).unblock() : $.unblockUI() },
        blockPage: function(t) { return KTApp.block("body", t) },
        unblockPage: function() { return KTApp.unblock("body") },
        getSettings: function() { return t }
    }
}();
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTApp), $(document).ready((function() { KTApp.init(KTAppSettings) })), window.onload = function() {
...
var KTCard = function(t, e) {
    ...
    if (n) {
        var o = { toggleSpeed: 400, sticky: { releseOnReverse: !1, offset: 300, zIndex: 101 } },
            l = {
                construct: function(t) { return KTUtil.data(n).has("card") ? a = KTUtil.data(n).get("card") : (l.init(t), l.build(), KTUtil.data(n).set("card", a)), a },
                init: function(t) { a.element = n, a.events = [], a.options = KTUtil.deepExtend({}, o, t), a.header = KTUtil.child(n, ".card-header"), a.footer = KTUtil.child(n, ".card-footer"), KTUtil.child(n, ".card-body") ? a.body = KTUtil.child(n, ".card-body") : KTUtil.child(n, ".form") && (a.body = KTUtil.child(n, ".form")) },
                build: function() {
                    var t = KTUtil.find(a.header, "[data-card-tool=remove]");
                    t && KTUtil.addEvent(t, "click", (function(t) { t.preventDefault(), l.remove() }));
                    var e = KTUtil.find(a.header, "[data-card-tool=reload]");
                    e && KTUtil.addEvent(e, "click", (function(t) { t.preventDefault(), l.reload() }));
                    var n = KTUtil.find(a.header, "[data-card-tool=toggle]");
                    n && KTUtil.addEvent(n, "click", (function(t) { t.preventDefault(), l.toggle() }))
                },
                initSticky: function() {
                ...
                resetSticky: function() { a.header && !1 === KTUtil.hasClass(i, "card-sticky-on") && (KTUtil.css(a.header, "z-index", ""), KTUtil.css(a.header, "top", ""), KTUtil.css(a.header, "left", ""), KTUtil.css(a.header, "right", "")) },
                remove: function() { var t;!1 !== l.eventTrigger("beforeRemove") && ((t = document.querySelectorAll(".tooltip.show")) && $(t).tooltip("dispose"), KTUtil.remove(n), l.eventTrigger("afterRemove")) },
                setContent: function(t) { t && (a.body.innerHTML = t) },
                getBody: function() { return a.body },
                getSelf: function() { return n },
                reload: function() { l.eventTrigger("reload") },
                toggle: function() { KTUtil.hasClass(n, "card-collapse") || KTUtil.hasClass(n, "card-collapsed") ? l.expand() : l.collapse() },
                collapse: function() {!1 !== l.eventTrigger("beforeCollapse") && (KTUtil.slideUp(a.body, a.options.toggleSpeed, (function() { l.eventTrigger("afterCollapse") })), KTUtil.addClass(n, "card-collapse")) },
                expand: function() {!1 !== l.eventTrigger("beforeExpand") && (KTUtil.slideDown(a.body, a.options.toggleSpeed, (function() { l.eventTrigger("afterExpand") })), KTUtil.removeClass(n, "card-collapse"), KTUtil.removeClass(n, "card-collapsed")) },
                eventTrigger: function(t) { for (var e = 0; e < a.events.length; e++) { var n = a.events[e]; if (n.name == t) { if (1 != n.one) return n.handler.call(this, a); if (0 == n.fired) return a.events[e].fired = !0, n.handler.call(this, a) } } },
                addEvent: function(t, e, n) { return a.events.push({ name: t, handler: e, one: n, fired: !1 }), a }
            };
        return a.setDefaults = function(t) { o = t }, a.remove = function() { return l.remove(html) }, a.initSticky = function() { return l.initSticky() }, a.updateSticky = function() { return l.updateSticky() }, a.resetSticky = function() { return l.resetSticky() }, a.destroySticky = function() { l.resetSticky(), window.removeEventListener("scroll", l.onScrollSticky) }, a.reload = function() { return l.reload() }, a.setContent = function(t) { return l.setContent(t) }, a.toggle = function() { return l.toggle() }, a.collapse = function() { return l.collapse() }, a.expand = function() { return l.expand() }, a.getBody = function() { return l.getBody() }, a.getSelf = function() { return l.getSelf() }, a.on = function(t, e) { return l.addEvent(t, e) }, a.one = function(t, e) { return l.addEvent(t, e, !0) }, l.construct.apply(a, [e]), a
    }
};
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTCard);
var KTCookie = {
    getCookie: function(t) { var e = document.cookie.match(new RegExp("(?:^|; )" + t.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g, "\\$1") + "=([^;]*)")); return e ? decodeURIComponent(e[1]) : void 0 },
    setCookie: function(t, e, a) {
        ...
        for (var i in a)
            if (a.hasOwnProperty(i)) { n += "; " + i; var o = a[i];!0 !== o && (n += "=" + o) }
        document.cookie = n
    },
    deleteCookie: function(t) { setCookie(t, "", { "max-age": -1 }) }
};
...
var KTDialog = function(t) {
    var e, a = this,
        ...
        o = { construct: function(t) { return o.init(t), a }, init: function(t) { a.events = [], a.options = KTUtil.deepExtend({}, i, t), a.state = !1 }, show: function() { return o.eventTrigger("show"), e = document.createElement("DIV"), KTUtil.setHTML(e, a.options.message), KTUtil.addClass(e, "dialog dialog-shown"), KTUtil.addClass(e, "dialog-" + a.options.state), KTUtil.addClass(e, "dialog-" + a.options.type), "top center" == a.options.placement && KTUtil.addClass(e, "dialog-top-center"), n.appendChild(e), a.state = "shown", o.eventTrigger("shown"), a }, hide: function() { return e && (o.eventTrigger("hide"), e.remove(), a.state = "hidden", o.eventTrigger("hidden")), a }, eventTrigger: function(t) { for (var e = 0; e < a.events.length; e++) { var n = a.events[e]; if (n.name == t) { if (1 != n.one) return n.handler.call(this, a); if (0 == n.fired) return a.events[e].fired = !0, n.handler.call(this, a) } } }, addEvent: function(t, e, n) { return a.events.push({ name: t, handler: e, one: n, fired: !1 }), a } };
    return a.setDefaults = function(t) { i = t }, a.shown = function() { return "shown" == a.state }, a.hidden = function() { return "hidden" == a.state }, a.show = function() { return o.show() }, a.hide = function() { return o.hide() }, a.on = function(t, e) { return o.addEvent(t, e) }, a.one = function(t, e) { return o.addEvent(t, e, !0) }, o.construct.apply(a, [t]), a
};
...
var KTHeader = function(t, e) {
    ...
    if (void 0 !== n) {
        var o = { offset: { desktop: !0, tabletAndMobile: !0 }, releseOnReverse: { desktop: !1, tabletAndMobile: !1 } },
            l = {
                construct: function(t) { return KTUtil.data(n).has("header") ? a = KTUtil.data(n).get("header") : (l.init(t), l.build(), KTUtil.data(n).set("header", a)), a },
                init: function(t) { a.events = [], a.options = KTUtil.deepExtend({}, o, t) },
                build: function() {
                    var t = !0,
                        e = 0;
                ...
                eventTrigger: function(t, e) { for (var n = 0; n < a.events.length; n++) { var i = a.events[n]; if (i.name == t) { if (1 != i.one) return i.handler.call(this, a, e); if (0 == i.fired) return a.events[n].fired = !0, i.handler.call(this, a, e) } } },
                addEvent: function(t, e, n) { a.events.push({ name: t, handler: e, one: n, fired: !1 }) }
            };
        return a.setDefaults = function(t) { o = t }, a.on = function(t, e) { return l.addEvent(t, e) }, l.construct.apply(a, [e]), !0, a
    }
};
...
var KTImageInput = function(t, e) {
    ...
    if (n) {
        var i = { editMode: !1 },
            o = {
                construct: function(t) { return KTUtil.data(n).has("imageinput") ? a = KTUtil.data(n).get("imageinput") : (o.init(t), o.build(), KTUtil.data(n).set("imageinput", a)), a },
                init: function(t) { a.element = n, a.events = [], a.input = KTUtil.find(n, 'input[type="file"]'), a.wrapper = KTUtil.find(n, ".image-input-wrapper"), a.cancel = KTUtil.find(n, '[data-action="cancel"]'), a.remove = KTUtil.find(n, '[data-action="remove"]'), a.src = KTUtil.css(a.wrapper, "backgroundImage"), a.hidden = KTUtil.find(n, 'input[type="hidden"]'), a.options = KTUtil.deepExtend({}, i, t) },
                build: function() {
                    KTUtil.addEvent(a.input, "change", (function(t) {
                        if (t.preventDefault(), a.input && a.input.files && a.input.files[0]) {
                            var e = new FileReader;
                            e.onload = function(t) { KTUtil.css(a.wrapper, "background-image", "url(" + t.target.result + ")") }, e.readAsDataURL(a.input.files[0]), KTUtil.addClass(a.element, "image-input-changed"), KTUtil.removeClass(a.element, "image-input-empty"), o.eventTrigger("change")
                        }
                    })), KTUtil.addEvent(a.cancel, "click", (function(t) { t.preventDefault(), o.eventTrigger("cancel"), KTUtil.removeClass(a.element, "image-input-changed"), KTUtil.removeClass(a.element, "image-input-empty"), KTUtil.css(a.wrapper, "background-image", a.src), a.input.value = "", a.hidden && (a.hidden.value = "0") })), KTUtil.addEvent(a.remove, "click", (function(t) { t.preventDefault(), o.eventTrigger("remove"), KTUtil.removeClass(a.element, "image-input-changed"), KTUtil.addClass(a.element, "image-input-empty"), KTUtil.css(a.wrapper, "background-image", "none"), a.input.value = "", a.hidden && (a.hidden.value = "1") }))
                },
                eventTrigger: function(t) { for (var e = 0; e < a.events.length; e++) { var n = a.events[e]; if (n.name == t) { if (1 != n.one) return n.handler.call(this, a); if (0 == n.fired) return a.events[e].fired = !0, n.handler.call(this, a) } } },
                addEvent: function(t, e, n) { return a.events.push({ name: t, handler: e, one: n, fired: !1 }), a }
            };
        return a.setDefaults = function(t) { i = t }, a.on = function(t, e) { return o.addEvent(t, e) }, a.one = function(t, e) { return o.addEvent(t, e, !0) }, o.construct.apply(a, [e]), a
    }
};
...
var KTMenu = function(t, e) {
    ...
    if (i) {
        var l = { scroll: { rememberPosition: !1 }, accordion: { slideSpeed: 200, autoScroll: !1, autoScrollSpeed: 1200, expandAll: !0 }, dropdown: { timeout: 500 } },
            r = {
                construct: function(t) { return KTUtil.data(i).has("menu") ? a = KTUtil.data(i).get("menu") : (r.init(t), r.reset(), r.build(), KTUtil.data(i).set("menu", a)), a },
                init: function(t) { a.events = [], a.eventHandlers = {}, a.options = KTUtil.deepExtend({}, l, t), a.pauseDropdownHoverTime = 0, a.uid = KTUtil.getUniqueID() },
                update: function(t) { a.options = KTUtil.deepExtend({}, l, t), a.pauseDropdownHoverTime = 0, r.reset(), a.eventHandlers = {}, r.build(), KTUtil.data(i).set("menu", a) },
                reload: function() { r.reset(), r.build(), r.resetSubmenuProps() },
                build: function() { a.eventHandlers.event_1 = KTUtil.on(i, ".menu-toggle", "click", r.handleSubmenuAccordion), ("dropdown" === r.getSubmenuMode() || r.isConditionalSubmenuDropdown()) && (a.eventHandlers.event_2 = KTUtil.on(i, '[data-menu-toggle="hover"]', "mouseover", r.handleSubmenuDrodownHoverEnter), a.eventHandlers.event_3 = KTUtil.on(i, '[data-menu-toggle="hover"]', "mouseout", r.handleSubmenuDrodownHoverExit), a.eventHandlers.event_4 = KTUtil.on(i, '[data-menu-toggle="click"] > .menu-toggle, [data-menu-toggle="click"] > .menu-link .menu-toggle', "click", r.handleSubmenuDropdownClick), a.eventHandlers.event_5 = KTUtil.on(i, '[data-menu-toggle="tab"] > .menu-toggle, [data-menu-toggle="tab"] > .menu-link .menu-toggle', "click", r.handleSubmenuDropdownTabClick)), a.eventHandlers.event_6 = KTUtil.on(i, ".menu-item > .menu-link:not(.menu-toggle):not(.menu-link-toggle-skip)", "click", r.handleLinkClick), a.options.scroll && a.options.scroll.height && r.scrollInit() },
                reset: function() { KTUtil.off(i, "click", a.eventHandlers.event_1), KTUtil.off(i, "mouseover", a.eventHandlers.event_2), KTUtil.off(i, "mouseout", a.eventHandlers.event_3), KTUtil.off(i, "click", a.eventHandlers.event_4), KTUtil.off(i, "click", a.eventHandlers.event_5), KTUtil.off(i, "click", a.eventHandlers.event_6) },
                scrollInit: function() { a.options.scroll && a.options.scroll.height ? (KTUtil.scrollDestroy(i, !0), KTUtil.scrollInit(i, { mobileNativeScroll: !0, windowScroll: !1, resetHeightOnDestroy: !0, handleWindowResize: !0, height: a.options.scroll.height, rememberPosition: a.options.scroll.rememberPosition })) : KTUtil.scrollDestroy(i, !0) },
                scrollUpdate: function() { a.options.scroll && a.options.scroll.height && KTUtil.scrollUpdate(i) },
                scrollTop: function() { a.options.scroll && a.options.scroll.height && KTUtil.scrollTop(i) },
                getSubmenuMode: function(t) { return KTUtil.isBreakpointUp("lg") ? t && KTUtil.hasAttr(t, "data-menu-toggle") && "hover" == KTUtil.attr(t, "data-menu-toggle") ? "dropdown" : KTUtil.isset(a.options.submenu, "desktop.state.body") ? KTUtil.hasClasses(o, a.options.submenu.desktop.state.body) ? a.options.submenu.desktop.state.mode : a.options.submenu.desktop.default : KTUtil.isset(a.options.submenu, "desktop") ? a.options.submenu.desktop : void 0 : KTUtil.isBreakpointUp("md") && KTUtil.isBreakpointDown("lg") && KTUtil.isset(a.options.submenu, "tablet") ? a.options.submenu.tablet : !(!KTUtil.isBreakpointDown("md") || !KTUtil.isset(a.options.submenu, "mobile")) && a.options.submenu.mobile },
                isConditionalSubmenuDropdown: function() { return !(!KTUtil.isBreakpointUp("lg") || !KTUtil.isset(a.options.submenu, "desktop.state.body")) },
                ...
                handleSubmenuDrodownHoverEnter: function(t) { if ("accordion" !== r.getSubmenuMode(this) && !1 !== a.resumeDropdownHover()) { var e = this; "1" == e.getAttribute("data-hover") && (e.removeAttribute("data-hover"), clearTimeout(e.getAttribute("data-timeout")), e.removeAttribute("data-timeout")), r.showSubmenuDropdown(e) } },
                handleSubmenuDrodownHoverExit: function(t) {
                    if (!1 !== a.resumeDropdownHover() && "accordion" !== r.getSubmenuMode(this)) {
                        var e = this,
                            ...
                            i = setTimeout((function() { "1" == e.getAttribute("data-hover") && r.hideSubmenuDropdown(e, !0) }), n);
                        e.setAttribute("data-hover", "1"), e.setAttribute("data-timeout", i)
                    }
                },
                handleSubmenuDropdownClick: function(t) { if ("accordion" !== r.getSubmenuMode(this)) { var e = this.closest(".menu-item");!1 !== r.eventTrigger("submenuToggle", this, t) && "accordion" != e.getAttribute("data-menu-submenu-mode") && (!1 === KTUtil.hasClass(e, "menu-item-hover") ? (KTUtil.addClass(e, "menu-item-open-dropdown"), r.showSubmenuDropdown(e)) : (KTUtil.removeClass(e, "menu-item-open-dropdown"), r.hideSubmenuDropdown(e, !0)), t.preventDefault()) } },
                handleSubmenuDropdownTabClick: function(t) { if ("accordion" !== r.getSubmenuMode(this)) { var e = this.closest(".menu-item");!1 !== r.eventTrigger("submenuToggle", this, t) && "accordion" != e.getAttribute("data-menu-submenu-mode") && (0 == KTUtil.hasClass(e, "menu-item-hover") && (KTUtil.addClass(e, "menu-item-open-dropdown"), r.showSubmenuDropdown(e)), t.preventDefault()) } },
                handleLinkClick: function(t) { var e = this.closest(".menu-item.menu-item-submenu");!1 !== r.eventTrigger("linkClick", this, t) && e && "dropdown" === r.getSubmenuMode(e) && r.hideSubmenuDropdowns() },
                                    ...
                                    if (!1 === a.options.accordion.expandAll) {
                                        ...
                                        if (d && c)
                                            for (var u = 0, p = c.length; u < p; u++) {
                                                ...
                                                g && KTUtil.slideUp(g, s, (function() { r.scrollUpdate(), KTUtil.removeClass(f, "menu-item-open") }))
                                            }
                                    }
                                    KTUtil.slideDown(l, s, (function() { r.scrollToItem(i), r.scrollUpdate(), r.eventTrigger("submenuToggle", l, t) })), KTUtil.addClass(o, "menu-item-open")
                                } else KTUtil.slideUp(l, s, (function() { r.scrollToItem(i), r.scrollUpdate(), r.eventTrigger("submenuToggle", l, t) })), KTUtil.removeClass(o, "menu-item-open")
                            }
                        }
                },
                scrollToItem: function(t) { KTUtil.isBreakpointUp("lg") && a.options.accordion.autoScroll && "1" !== i.getAttribute("data-menu-scroll") && KTUtil.scrollTo(t, a.options.accordion.autoScrollSpeed) },
                ...
                createSubmenuDropdownClickDropoff: function(t) {
                    ...
                    o.appendChild(n), KTUtil.addEvent(n, "click", (function(e) { e.stopPropagation(), e.preventDefault(), KTUtil.remove(this), r.hideSubmenuDropdown(t, !0) }))
                },
                ...
                getBreadcrumbs: function(t) {
                    ...
                    a.push({ text: e = KTUtil.child(n, ".menu-text") ? e.innerHTML : "", title: n.getAttribute("title"), href: n.getAttribute("href") });
                    for (var i = KTUtil.parents(t, ".menu-item-submenu"), o = 0, l = i.length; o < l; o++) {
                        var r = KTUtil.child(i[o], ".menu-link");
                        a.push({ text: e = KTUtil.child(r, ".menu-text") ? e.innerHTML : "", title: r.getAttribute("title"), href: r.getAttribute("href") })
                    }
                    return a.reverse()
                },
                getPageTitle: function(t) { var e; return KTUtil.child(t, ".menu-text") ? e.innerHTML : "" },
                eventTrigger: function(t, e, n) { for (var i = 0; i < a.events.length; i++) { var o = a.events[i]; if (o.name == t) { if (1 != o.one) return o.handler.call(this, e, n); if (0 == o.fired) return a.events[i].fired = !0, o.handler.call(this, e, n) } } },
                addEvent: function(t, e, n) { a.events.push({ name: t, handler: e, one: n, fired: !1 }) },
                removeEvent: function(t) { a.events[t] && delete a.events[t] }
            };
        return a.setDefaults = function(t) { l = t }, a.scrollUpdate = function() { return r.scrollUpdate() }, a.scrollReInit = function() { return r.scrollInit() }, a.scrollTop = function() { return r.scrollTop() }, a.setActiveItem = function(t) { return r.setActiveItem(t) }, a.reload = function() { return r.reload() }, a.update = function(t) { return r.update(t) }, a.getBreadcrumbs = function(t) { return r.getBreadcrumbs(t) }, a.getPageTitle = function(t) { return r.getPageTitle(t) }, a.getSubmenuMode = function(t) { return r.getSubmenuMode(t) }, a.hideDropdown = function(t) { r.hideSubmenuDropdown(t, !0) }, a.hideDropdowns = function() { r.hideSubmenuDropdowns() }, a.pauseDropdownHover = function(t) { r.pauseDropdownHover(t) }, a.resumeDropdownHover = function() { return r.resumeDropdownHover() }, a.on = function(t, e) { return r.addEvent(t, e) }, a.off = function(t) { return r.removeEvent(t) }, a.one = function(t, e) { return r.addEvent(t, e, !0) }, r.construct.apply(a, [e]), KTUtil.addResizeHandler((function() { n && a.reload() })), n = !0, a
    }
};
...
var KTOffcanvas = function(t, e) {
    ...
    if (n) {
        var o = { attrCustom: "" },
            l = {
                construct: function(t) { return KTUtil.data(n).has("offcanvas") ? a = KTUtil.data(n).get("offcanvas") : (l.init(t), l.build(), KTUtil.data(n).set("offcanvas", a)), a },
                init: function(t) { a.events = [], a.options = KTUtil.deepExtend({}, o, t), a.classBase = a.options.baseClass, a.attrCustom = a.options.attrCustom, a.classShown = a.classBase + "-on", a.classOverlay = a.classBase + "-overlay", a.target, a.state = KTUtil.hasClass(n, a.classShown) ? "shown" : "hidden" },
                build: function() {
                    if (a.options.toggleBy)
                        if ("string" == typeof a.options.toggleBy) KTUtil.addEvent(KTUtil.getById(a.options.toggleBy), "click", (function(t) { t.preventDefault(), a.target = this, l.toggle() }));
                        else if (a.options.toggleBy && a.options.toggleBy[0])
                        if (a.options.toggleBy[0].target)
                            for (var t in a.options.toggleBy) KTUtil.addEvent(KTUtil.getById(a.options.toggleBy[t].target), "click", (function(t) { t.preventDefault(), a.target = this, l.toggle() }));
                        else
                            for (var t in a.options.toggleBy) KTUtil.addEvent(KTUtil.getById(a.options.toggleBy[t]), "click", (function(t) { t.preventDefault(), a.target = this, l.toggle() }));
                    else a.options.toggleBy && a.options.toggleBy.target && KTUtil.addEvent(KTUtil.getById(a.options.toggleBy.target), "click", (function(t) { t.preventDefault(), a.target = this, l.toggle() }));
                    var e = KTUtil.getById(a.options.closeBy);
                    e && KTUtil.addEvent(e, "click", (function(t) { t.preventDefault(), a.target = this, l.hide() }))
                },
                isShown: function() { return "shown" == a.state },
                toggle: function() { l.eventTrigger("toggle"), "shown" == a.state ? l.hide() : l.show() },
                show: function() { "shown" != a.state && (l.eventTrigger("beforeShow"), l.toggleClass("show"), KTUtil.attr(i, "data-offcanvas-" + a.classBase, "on"), KTUtil.addClass(n, a.classShown), a.attrCustom.length > 0 && KTUtil.attr(i, "data-offcanvas-" + a.classCustom, "on"), a.state = "shown", a.options.overlay && (a.overlay = KTUtil.insertAfter(document.createElement("DIV"), n), KTUtil.addClass(a.overlay, a.classOverlay), KTUtil.addEvent(a.overlay, "click", (function(t) { t.preventDefault(), l.hide(a.target) }))), l.eventTrigger("afterShow")) },
                hide: function() { "hidden" != a.state && (l.eventTrigger("beforeHide"), l.toggleClass("hide"), KTUtil.removeAttr(i, "data-offcanvas-" + a.classBase), KTUtil.removeClass(n, a.classShown), a.attrCustom.length > 0 && KTUtil.removeAttr(i, "data-offcanvas-" + a.attrCustom), a.state = "hidden", a.options.overlay && a.overlay && KTUtil.remove(a.overlay), l.eventTrigger("afterHide")) },
                toggleClass: function(t) {
                    ...
                    if (e) { var o = KTUtil.getById(e.target); "show" === t && KTUtil.addClass(o, e.state), "hide" === t && KTUtil.removeClass(o, e.state) }
                },
                eventTrigger: function(t, e) { for (var n = 0; n < a.events.length; n++) { var i = a.events[n]; if (i.name == t) { if (1 != i.one) return i.handler.call(this, a, e); if (0 == i.fired) return a.events[n].fired = !0, i.handler.call(this, a, e) } } },
                addEvent: function(t, e, n) { a.events.push({ name: t, handler: e, one: n, fired: !1 }) }
            };
        return a.setDefaults = function(t) { o = t }, a.isShown = function() { return l.isShown() }, a.hide = function() { return l.hide() }, a.show = function() { return l.show() }, a.on = function(t, e) { return l.addEvent(t, e) }, a.one = function(t, e) { return l.addEvent(t, e, !0) }, l.construct.apply(a, [e]), !0, a
    }
};
...
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTToggle), Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), Element.prototype.closest || (Element.prototype.matches || (Element.prototype.matches = Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector), Element.prototype.closest = function(t) {
     ...
     */
    ,
    function(t) { for (var e = 0; e < t.length; e++) window[t[e]] && !("remove" in window[t[e]].prototype) && (window[t[e]].prototype.remove = function() { this.parentNode.removeChild(this) }) }(["Element", "CharacterData", "DocumentType"]),
    function() {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function(e) {
            var a = (new Date).getTime(),
                n = Math.max(0, 16 - (a - t)),
                i = window.setTimeout((function() { e(a + n) }), n);
            return t = a + n, i
    ...
    })), null == Element.prototype.getAttributeNames && (Element.prototype.getAttributeNames = function() { for (var t = this.attributes, e = t.length, a = new Array(e), n = 0; n < e; n++) a[n] = t[n].name; return a }), window.KTUtilElementDataStore = {}, window.KTUtilElementDataStoreID = 0, window.KTUtilDelegatedEventHandlers = {};
var KTUtil = function() {
    var t = [],
        e = { sm: 544, md: 768, lg: 992, xl: 1200 },
        a = function() { window.addEventListener("resize", (function() { KTUtil.throttle(undefined, (function() {! function() { for (var e = 0; e < t.length; e++) t[e].call() }() }), 200) })) };
    return {
        ...
        isMobileDevice: function() { var t = this.getViewPort().width < this.getBreakpoint("lg"); return !1 === t && (t = null != navigator.userAgent.match(/iPad/i)), t },
        ...
        isBreakpointUp: function(t) { return this.getViewPort().width >= this.getBreakpoint(t) },
        isBreakpointDown: function(t) { return this.getViewPort().width < this.getBreakpoint(t) },
        ...
        getById: function(t) { return "string" == typeof t ? document.getElementById(t) : t },
        getByTag: function(t) { return document.getElementsByTagName(t) },
        getByTagName: function(t) { return document.getElementsByTagName(t) },
        getByClass: function(t) { return document.getElementsByClassName(t) },
        ...
        find: function(t, e) { if (t = KTUtil.getById(t)) return t.querySelector(e) },
        findAll: function(t, e) { if (t = KTUtil.getById(t)) return t.querySelectorAll(e) },
        insertAfter: function(t, e) { return e.parentNode.insertBefore(t, e.nextSibling) },
        parents: function(t, e) { Element.prototype.matches || (Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector || function(t) { for (var e = (this.document || this.ownerDocument).querySelectorAll(t), a = e.length; --a >= 0 && e.item(a) !== this;); return a > -1 }); for (var a = []; t && t !== document; t = t.parentNode) e ? t.matches(e) && a.push(t) : a.push(t); return a },
        children: function(t, e, a) { if (t && t.childNodes) { for (var n = [], i = 0, o = t.childNodes.length; i < o; ++i) 1 == t.childNodes[i].nodeType && KTUtil.matches(t.childNodes[i], e, a) && n.push(t.childNodes[i]); return n } },
        child: function(t, e, a) { var n = KTUtil.children(t, e, a); return n ? n[0] : null },
        matches: function(t, e, a) {
            var n = Element.prototype,
                i = n.matches || n.webkitMatchesSelector || n.mozMatchesSelector || n.msMatchesSelector || function(t) { return -1 !== [].indexOf.call(document.querySelectorAll(t), this) };
            return !(!t || !t.tagName) && i.call(t, e)
        },
        data: function(t) { return { set: function(e, a) { t && (void 0 === t.customDataTag && (window.KTUtilElementDataStoreID++, t.customDataTag = window.KTUtilElementDataStoreID), void 0 === window.KTUtilElementDataStore[t.customDataTag] && (window.KTUtilElementDataStore[t.customDataTag] = {}), window.KTUtilElementDataStore[t.customDataTag][e] = a) }, get: function(e) { if (t) return void 0 === t.customDataTag ? null : this.has(e) ? window.KTUtilElementDataStore[t.customDataTag][e] : null }, has: function(e) { return !!t && (void 0 !== t.customDataTag && !(!window.KTUtilElementDataStore[t.customDataTag] || !window.KTUtilElementDataStore[t.customDataTag][e])) }, remove: function(e) { t && this.has(e) && delete window.KTUtilElementDataStore[t.customDataTag][e] } } },
        outerWidth: function(t, e) { var a; return !0 === e ? (a = parseFloat(t.offsetWidth), a += parseFloat(KTUtil.css(t, "margin-left")) + parseFloat(KTUtil.css(t, "margin-right")), parseFloat(a)) : a = parseFloat(t.offsetWidth) },
        offset: function(t) { var e, a; if (t) return t.getClientRects().length ? (e = t.getBoundingClientRect(), a = t.ownerDocument.defaultView, { top: e.top + a.pageYOffset, left: e.left + a.pageXOffset }) : { top: 0, left: 0 } },
        height: function(t) { return KTUtil.css(t, "height") },
        outerHeight: function(t, e) { var a, n = t.offsetHeight; return void 0 !== e && !0 === e ? (a = getComputedStyle(t), n += parseInt(a.marginTop) + parseInt(a.marginBottom)) : n },
        visible: function(t) { return !(0 === t.offsetWidth && 0 === t.offsetHeight) },
        attr: function(t, e, a) { if (null != t) return void 0 === a ? t.getAttribute(e) : void t.setAttribute(e, a) },
        hasAttr: function(t, e) { if (null != t) return !!t.getAttribute(e) },
        removeAttr: function(t, e) { null != t && t.removeAttribute(e) },
        animate: function(t, e, a, n, i, o) {
            var l = {};
            if (l.linear = function(t, e, a, n) { return a * t / n + e }, i = l.linear, "number" == typeof t && "number" == typeof e && "number" == typeof a && "function" == typeof n) {
        ...
        slide: function(t, e, a, n, i) {
            if (!(!t || "up" == e && !1 === KTUtil.visible(t) || "down" == e && !0 === KTUtil.visible(t))) {
                ...
                var o = KTUtil.actualHeight(t),
                    l = !1,
                    r = !1;
                KTUtil.css(t, "padding-top") && !0 !== KTUtil.data(t).has("slide-padding-top") && KTUtil.data(t).set("slide-padding-top", KTUtil.css(t, "padding-top")), KTUtil.css(t, "padding-bottom") && !0 !== KTUtil.data(t).has("slide-padding-bottom") && KTUtil.data(t).set("slide-padding-bottom", KTUtil.css(t, "padding-bottom")), KTUtil.data(t).has("slide-padding-top") && (l = parseInt(KTUtil.data(t).get("slide-padding-top"))), KTUtil.data(t).has("slide-padding-bottom") && (r = parseInt(KTUtil.data(t).get("slide-padding-bottom"))), "up" == e ? (t.style.cssText = "display: block; overflow: hidden;", l && KTUtil.animate(0, l, a, (function(e) { t.style.paddingTop = l - e + "px" }), "linear"), r && KTUtil.animate(0, r, a, (function(e) { t.style.paddingBottom = r - e + "px" }), "linear"), KTUtil.animate(0, o, a, (function(e) { t.style.height = o - e + "px" }), "linear", (function() { t.style.height = "", t.style.display = "none", "function" == typeof n && n() }))) : "down" == e && (t.style.cssText = "display: block; overflow: hidden;", l && KTUtil.animate(0, l, a, (function(e) { t.style.paddingTop = e + "px" }), "linear", (function() { t.style.paddingTop = "" })), r && KTUtil.animate(0, r, a, (function(e) { t.style.paddingBottom = e + "px" }), "linear", (function() { t.style.paddingBottom = "" })), KTUtil.animate(0, o, a, (function(e) { t.style.height = e + "px" }), "linear", (function() { t.style.height = "", t.style.display = "", t.style.overflow = "", "function" == typeof n && n() })))
            }
        },
        slideUp: function(t, e, a) { KTUtil.slide(t, "up", e, a) },
        slideDown: function(t, e, a) { KTUtil.slide(t, "down", e, a) },
        show: function(t, e) { void 0 !== t && (t.style.display = e || "block") },
        hide: function(t) { void 0 !== t && (t.style.display = "none") },
        addEvent: function(t, e, a, n) { null != t && t.addEventListener(e, a) },
        removeEvent: function(t, e, a) { null !== t && t.removeEventListener(e, a) },
        on: function(t, e, a, n) {
            if (e) {
        ...
        off: function(t, e, a) { t && window.KTUtilDelegatedEventHandlers[a] && (KTUtil.removeEvent(t, e, window.KTUtilDelegatedEventHandlers[a]), delete window.KTUtilDelegatedEventHandlers[a]) },
        one: function(t, e, a) { t.addEventListener(e, (function e(n) { return n.target && n.target.removeEventListener && n.target.removeEventListener(n.type, e), t && t.removeEventListener && n.currentTarget.removeEventListener(n.type, e), a(n) })) },
        ...
        animateClass: function(t, e, a) {
            ...
            KTUtil.addClass(t, "animated " + e), KTUtil.one(t, n, (function() { KTUtil.removeClass(t, "animated " + e) })), a && KTUtil.one(t, n, a)
        },
        ...
        animateDelay: function(t, e) { for (var a = ["webkit-", "moz-", "ms-", "o-", ""], n = 0; n < a.length; n++) KTUtil.css(t, a[n] + "animation-delay", e) },
        animateDuration: function(t, e) { for (var a = ["webkit-", "moz-", "ms-", "o-", ""], n = 0; n < a.length; n++) KTUtil.css(t, a[n] + "animation-duration", e) },
        scrollTo: function(t, e, a) {
            ...
            e && (l += e), n = l, i = o, KTUtil.animate(n, i, a, (function(t) { document.documentElement.scrollTop = t, document.body.parentNode.scrollTop = t, document.body.scrollTop = t }))
        },
        scrollTop: function(t, e) { KTUtil.scrollTo(null, t, e) },
        ...
        numberString: function(t) { for (var e = (t += "").split("."), a = e[0], n = e.length > 1 ? "." + e[1] : "", i = /(\d+)(\d{3})/; i.test(a);) a = a.replace(i, "$1,$2"); return a + n },
        detectIE: function() {
        ...
        isRTL: function() { var t = KTUtil.getByTagName("html")[0]; if (t) return "rtl" == KTUtil.attr(t, "direction") },
        scrollInit: function(t, e) {
            if (t) { e = KTUtil.deepExtend({}, { wheelSpeed: .5, swipeEasing: !0, wheelPropagation: !1, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: !0 }, e), a(), e.handleWindowResize && KTUtil.addResizeHandler((function() { a() })) }

            function a() {
                var a, n, i = t.getAttributeNames();
                if (i.length > 0 && i.forEach((function(a) {
                        if (/^data-.*/g.test(a) && 0 == ["scroll", "height", "mobile-height"].includes(n)) {
                            var n = a.replace("data-", "").toLowerCase().replace(/(?:[\s-])\w/g, (function(t) { return t.replace("-", "").toUpperCase() }));
                    ...
                    if (n = parseInt(n), !e.mobileNativeScroll && !e.disableForMobile || !0 !== KTUtil.isMobileDevice())
                        if (n > 0 && KTUtil.css(t, "height", n + "px"), e.desktopNativeScroll) KTUtil.css(t, "overflow", "auto");
                            ...
                            if (!0 === e.rememberPosition && KTCookie && o) {
                                ...
                                t.addEventListener("ps-scroll-y", (function() { KTCookie.setCookie(o, t.scrollTop) }))
                            }
                        }
        ...
        scrollUpdateAll: function(t) { for (var e = KTUtil.findAll(t, ".ps"), a = 0, n = e.length; a < n; a++) KTUtil.scrollUpdate(e[a]) },
        ...
        filterBoolean: function(t) { return !0 === t || "true" === t || !1 !== t && "false" !== t && t },
        setHTML: function(t, e) { t.innerHTML = e },
        getHTML: function(t) { if (t) return t.innerHTML },
        ...
        throttle: function(t, e, a) { t || (t = setTimeout((function() { e(), t = void 0 }), a)) },
        debounce: function(t, e, a) { clearTimeout(t), t = setTimeout(e, a) },
        ...
        isOffscreen: function(t, e, a) {
            ...
            if ("bottom" == e) { if (i < o + l) return !0; if (i > o + 1.5 * l) return !0 }
            if ("top" == e) { if (o < 0) return !0; if (o > l) return !0 }
            return "left" == e && r < 0 || "right" == e && n < r + s
        }
    }
}();
"undefined" != typeof module && void 0 !== module.exports && (module.exports = KTUtil), KTUtil.ready((function() { "undefined" != typeof KTAppSettings ? KTUtil.init(KTAppSettings) : KTUtil.init() }));
var KTWizard = function(t, e) {
    ...
    if (n) {
        var i = { startStep: 1, clickableSteps: !1, navigation: !0 },
            o = {
                construct: function(t) { return KTUtil.data(n).has("wizard") ? a = KTUtil.data(n).get("wizard") : (o.init(t), o.build(), KTUtil.data(n).set("wizard", a)), a },
                init: function(t) { a.element = n, a.events = [], a.options = KTUtil.deepExtend({}, i, t), a.steps = KTUtil.findAll(n, '[data-wizard-type="step"]'), a.btnNext = KTUtil.find(n, '[data-wizard-type="action-next"]'), a.btnPrev = KTUtil.find(n, '[data-wizard-type="action-prev"]'), a.btnSubmit = KTUtil.find(n, '[data-wizard-type="action-submit"]'), a.events = [], a.lastStep = 0, a.currentStep = 1, a.newStep = 0, a.stopped = !1, a.totalSteps = a.steps.length, a.options.startStep > 1 && o.goTo(a.options.startStep), o.updateUI() },
                build: function() {
                    a.options.navigation && (KTUtil.addEvent(a.btnNext, "click", (function(t) { t.preventDefault(), o.setNewStep(o.getNextStep()), !1 !== o.eventTrigger("change") && o.goTo(o.getNextStep()) })), KTUtil.addEvent(a.btnPrev, "click", (function(t) { t.preventDefault(), o.setNewStep(o.getPrevStep()), !1 !== o.eventTrigger("change") && o.goTo(o.getPrevStep()) })), KTUtil.addEvent(a.btnSubmit, "click", (function(t) { t.preventDefault(), o.eventTrigger("submit") }))), !0 === a.options.clickableSteps && KTUtil.on(n, '[data-wizard-type="step"]', "click", (function() {
                        var t = KTUtil.index(this) + 1;
                        t !== a.currentStep && (o.setNewStep(t), !1 !== o.eventTrigger("change") && o.goTo(t))
                    }))
                },
                goTo: function(t) { if (!0 !== a.stopped) { if (!(t === a.currentStep || t > a.totalSteps || t < 0)) return t = parseInt(t), a.lastStep = a.currentStep, a.currentStep = t, a.newStep = 0, o.updateUI(), o.eventTrigger("changed"), a } else a.stopped = !1 },
                stop: function() { a.stopped = !0 },
                resume: function() { a.stopped = !1 },
                isLastStep: function() { return a.currentStep === a.totalSteps },
                isFirstStep: function() { return 1 === a.currentStep },
                isBetweenStep: function() { return !1 === o.isLastStep() && !1 === o.isFirstStep() },
                updateUI: function() {
                    var t = "",
                        e = a.currentStep - 1;
                ...
                getNewStep: function() { return a.newStep },
                setNewStep: function(t) { a.newStep = t },
                eventTrigger: function(t, e) { for (var n = 0; n < a.events.length; n++) { var i = a.events[n]; if (i.name == t) { if (1 != i.one) return i.handler.call(this, a); if (0 == i.fired) return a.events[n].fired = !0, i.handler.call(this, a) } } },
                addEvent: function(t, e, n) { return a.events.push({ name: t, handler: e, one: n, fired: !1 }), a }
            };
        return a.setDefaults = function(t) { i = t }, a.goNext = function() { return o.goTo(o.getNextStep()) }, a.goPrev = function() { return o.goTo(o.getPrevStep()) }, a.goLast = function() { return o.goTo(o.getLastStep()) }, a.goFirst = function() { return o.goTo(o.getFirstStep()) }, a.goTo = function(t) { return o.goTo(t) }, a.stop = function() { return o.stop() }, a.resume = function() { return o.resume() }, a.getStep = function() { return a.currentStep }, a.getNewStep = function() { return o.getNewStep() }, a.setNewStep = function(t) { o.setNewStep(t) }, a.isLastStep = function() { return o.isLastStep() }, a.isFirstStep = function() { return o.isFirstStep() }, a.on = function(t, e) { return o.addEvent(t, e) }, a.one = function(t, e) { return o.addEvent(t, e, !0) }, o.construct.apply(a, [e]), a
    }
};
        ...
        t.fn.KTDatatable = function(i) {
            if (0 !== t(this).length) {
                ...
                var l = {
                    ...
                    fullRender: function() { t(o.tableHead).empty(), l.setHeadTitle(), l.getOption("layout.footer") && (t(o.tableFoot).empty(), l.setHeadTitle(o.tableFoot)), l.spinnerCallback(!0), t(o.wrap).removeClass("datatable-loaded"), l.insertData() },
                    lockEnabledColumns: function() {
                        var e = t(window).width(),
                            n = i.columns,
                            o = { left: [], right: [] };
                        return t.each(n, (function(t, n) { void 0 !== n.locked && (void 0 !== n.locked.left && a.getBreakpoint(n.locked.left) <= e && o.left.push(n.locked.left), void 0 !== n.locked.right && a.getBreakpoint(n.locked.right) <= e && o.right.push(n.locked.right)) })), o
                    },
                    afterRender: function(e, a) { t(o).ready((function() { l.isLocked() && l.redraw(), t(o.tableBody).css("visibility", ""), t(o.wrap).addClass("datatable-loaded"), l.spinnerCallback(!1) })) },
                    hoverTimer: 0,
                    isScrolling: !1,
                    setupHover: function() {
                        t(window).scroll((function(t) { clearTimeout(l.hoverTimer), l.isScrolling = !0 })), t(o.tableBody).find(".datatable-cell").off("mouseenter", "mouseleave").on("mouseenter", (function() {
                            if (l.hoverTimer = setTimeout((function() { l.isScrolling = !1 }), 200), !l.isScrolling) {
                    ...
                    dragResize: function() {
                        var e, a, n = !1,
                            i = void 0;
                        t(o.tableHead).find(".datatable-cell").mousedown((function(o) { i = t(this), n = !0, e = o.pageX, a = t(this).width(), t(i).addClass("datatable-cell-resizing") })).mousemove((function(l) {
                            if (n) {
                                var r = t(i).index(),
                                    s = t(o.tableBody),
                                ...
                                t(s).find(".datatable-row").each((function(n, i) { t(i).find(".datatable-cell").eq(r).width(a + (l.pageX - e)).children().width(a + (l.pageX - e)) })), t(i).children().css("width", a + (l.pageX - e))
                            }
                        })).mouseup((function() { t(i).removeClass("datatable-cell-resizing"), n = !1 })), t(document).mouseup((function() { t(i).removeClass("datatable-cell-resizing"), n = !1 }))
                    },
                    initHeight: function() {
                    ...
                    setupBaseDOM: function() { o.initialDatatable = t(o).clone(), "TABLE" === t(o).prop("tagName") ? (o.table = t(o).removeClass("datatable").addClass("datatable-table"), 0 === t(o.table).parents(".datatable").length && (o.table.wrap(t("<div/>").addClass("datatable").addClass("datatable-" + i.layout.theme)), o.wrap = t(o.table).parent())) : (o.wrap = t(o).addClass("datatable").addClass("datatable-" + i.layout.theme), o.table = t("<table/>").addClass("datatable-table").appendTo(o)), void 0 !== i.layout.class && t(o.wrap).addClass(i.layout.class), t(o.table).removeClass("datatable-destroyed").css("display", "block"), void 0 === t(o).attr("id") && (l.setOption("data.saveState", !1), t(o.table).attr("id", a.getUniqueID("datatable-"))), l.getOption("layout.minHeight") && t(o.table).css("min-height", l.getOption("layout.minHeight")), l.getOption("layout.height") && t(o.table).css("max-height", l.getOption("layout.height")), null === i.data.type && t(o.table).css("width", "").css("display", ""), o.tableHead = t(o.table).find("thead"), 0 === t(o.tableHead).length && (o.tableHead = t("<thead/>").prependTo(o.table)), o.tableBody = t(o.table).find("tbody"), 0 === t(o.tableBody).length && (o.tableBody = t("<tbody/>").appendTo(o.table)), void 0 !== i.layout.footer && i.layout.footer && (o.tableFoot = t(o.table).find("tfoot"), 0 === t(o.tableFoot).length && (o.tableFoot = t("<tfoot/>").appendTo(o.table))) },
                    setupCellField: function(e) {
                        void 0 === e && (e = t(o.table).children());
                        var a = i.columns;
                        t.each(e, (function(e, n) { t(n).find(".datatable-row").each((function(e, n) { t(n).find(".datatable-cell").each((function(e, n) { void 0 !== a[e] && t(n).data(a[e]) })) })) }))
                    },
                        ...
                        t(e).find(".datatable-row").each((function(e, n) {
                            ...
                            if (void 0 !== i) {
                                ...
                                "function" == typeof s && s(t(n), i, e), void 0 === i && (i = {}, t(n).find(".datatable-cell").each((function(e, n) {
                                    var o = t.grep(a, (function(e, a) { return t(n).data("field") === e.field }))[0];
                                    void 0 !== o && (i[o.field] = t(n).text())
                                }))), t(n).find(".datatable-cell").each((function(n, r) {
                                    var s = t.grep(a, (function(e, a) { return t(r).data("field") === e.field }))[0];
                        ...
                        if (o.dataSet = o.dataSet || [], 0 !== o.dataSet.length) {
                                ...
                                t(n).find(".datatable-cell").each((function(a, n) {
                                    ...
                                    if (void 0 !== i) {
                                        ...
                                        if (void 0 !== i.selector && !1 !== i.selector) {
                                            ...
                                            var r = t("<label/>").addClass("checkbox checkbox-single").append(t("<input/>").attr("type", "checkbox").attr("value", o).on("click", (function() { t(this).is(":checked") ? l.setActive(this) : l.setInactive(this) }))).append("&nbsp;<span></span>");
                            ...
                            var a = function(a) {
                                ...
                                if (void 0 !== n && void 0 !== n.selector && !1 !== n.selector) {
                                    ...
                                    var o = t("<label/>").addClass("checkbox checkbox-single checkbox-all").append(t("<input/>").attr("type", "checkbox").on("click", (function() { t(this).is(":checked") ? l.setActiveAll(!0) : l.setActiveAll(!1) }))).append("&nbsp;<span></span>");
                                ...
                                if (void 0 !== r)
                                    if ("auto" === r) {
                                        ...
                                        if (l.maxWidthList[s]) i = l.maxWidthList[s];
                                            ...
                                            i = l.maxWidthList[s] = Math.max.apply(null, t(d).map((function() { return t(this).outerWidth() })).get())
                                        }
                                    } else i = r;
                    ...
                    scrollbar: function() {
                        var e = {
                            ...
                            initDefaultScrollbar: function(a) { e.initPosition = t(a).scrollLeft(), t(a).css("overflow-y", "auto").off().on("scroll", e.onScrolling), t(a).css("overflow-x", "auto") },
                            onScrolling: function(n) {
                                var i = t(this).scrollLeft(),
                                    o = t(this).scrollTop();
                                a.isRTL() && (i -= e.initPosition), t(e.scrollHead).css("left", -i), t(e.scrollFoot).css("left", -i), t(e.tableLocked).each((function(e, a) { l.isLocked() && (o -= 1), t(a).css("top", -o) }))
                            },
                            initCustomScrollbar: function(a) { e.scrollable = a, l.initScrollbar(a), e.initPosition = t(a).scrollLeft(), t(a).off().on("scroll", e.onScrolling) }
                        };
                        return e.init(), e
                    },
                    initScrollbar: function(e, n) {
                        if (e && e.nodeName) {
                            ...
                            var i = t(e).data("ps");
                            a.hasClass(e, "ps") && void 0 !== i ? i.update() : (i = new PerfectScrollbar(e, Object.assign({}, { wheelSpeed: .5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: l.getOption("rows.autoHide") && !l.isLocked() }, n)), t(e).data("ps", i)), t(window).resize((function() { i.update() }))
                        }
                    },
                    setHeadTitle: function(e) {
                        ...
                        void 0 === r && (r = document.createElement("tr"), e.appendChild(r)), t.each(n, (function(e, n) {
                            var i = s[e];
                            if (void 0 === i && (i = document.createElement("th"), r.appendChild(i)), void 0 !== n.title && (i.innerHTML = n.title, i.setAttribute("data-field", n.field), a.addClass(i, n.class), void 0 !== n.autoHide && (!0 !== n.autoHide ? i.setAttribute("data-autohide-disabled", n.autoHide) : i.setAttribute("data-autohide-enabled", n.autoHide)), t(i).data(n)), void 0 !== n.attr && t.each(n.attr, (function(t, e) { i.setAttribute(t, e) })), void 0 !== n.textAlign) {
                    ...
                    dataRender: function(e) {
                        ...
                        var a = function() {
                            ...
                            n = function(e) {
                                var n = function(e, a) {
                                    t(e.pager).hasClass("datatable-paging-loaded") || (t(e.pager).remove(), e.init(a)), t(e.pager).off().on("datatable-on-goto-page", (function(n) { t(e.pager).remove(), e.init(a) }));
                        ...
                        "local" === i.data.type || !1 === i.data.serverSorting && "sort" === e || !1 === i.data.serverFiltering && "search" === e ? setTimeout((function() { l.setAutoColumns(), n() })) : l.getData().done(n)
                    },
                    insertData: function() {
                        o.dataSet = o.dataSet || [];
                        ...
                        if (t.each(o.dataSet, (function(n, r) {
                                ...
                                s.setAttribute("data-row", n), t(s).data("obj", r), void 0 !== d[n] && t.each(d[n], (function() { s.setAttribute(this.name, this.value) }));
                                for (var p = 0; p < u; p += 1) {
                                    var f = i.columns[p],
                                        g = [];
                    ...
                    updateTableComponents: function() { o.tableHead = t(o.table).children("thead").get(0), o.tableBody = t(o.table).children("tbody").get(0), o.tableFoot = t(o.table).children("tfoot").get(0) },
                    getData: function() {
                        ...
                        return t.ajax(e).done((function(e, a, n) { o.lastResponse = e, o.dataSet = o.originalDataSet = l.dataMapCallback(e), l.setAutoColumns(), t(o).trigger("datatable-on-ajax-done", [o.dataSet]) })).fail((function(e, a, n) { t(o).trigger("datatable-on-ajax-fail", [e]), t(o.tableBody).html(t("<span/>").addClass("datatable-error").html(l.getOption("translate.records.noRecords"))), t(o.wrap).addClass("datatable-error datatable-loaded"), l.spinnerCallback(!1) })).always((function() {}))
                    },
                    paging: function(e, n) {
                        var i = {
                            meta: null,
                            ...
                            populate: function() {
                                if (o.dataSet = o.dataSet || [], 0 !== o.dataSet.length) {
                                    ...
                                    0 == f.length && (f = [5, 10, 20, 30, 50, 100]), t.each(f, (function(e, a) { var n = a; - 1 === a && (n = l.getOption("translate.toolbar.pagination.items.default.all")), t("<option/>").attr("value", a).html(n).appendTo(p) })), t(o).ready((function() { t(".selectpicker").selectpicker().on("hide.bs.select", (function() { t(this).closest(".bootstrap-select").removeClass("dropup") })).siblings(".dropdown-toggle").attr("title", l.getOption("translate.toolbar.pagination.items.default.select")) })), i.paste()
                                }
                            },
                            paste: function() { t.each(t.unique(l.getOption("toolbar.placement")), (function(e, a) { "bottom" === a && t(i.pager).clone(!0).insertAfter(o.table), "top" === a && t(i.pager).clone(!0).addClass("datatable-pager-top").insertBefore(o.table) })) },
                            gotoMorePage: function(e) { if (e.preventDefault(), "disabled" === t(this).attr("disabled")) return !1; var a = t(this).attr("data-page"); return void 0 === a && (a = t(e.target).attr("data-page")), i.openPage(parseInt(a)), !1 },
                            gotoPage: function(e) { e.preventDefault(), t(this).hasClass("datatable-pager-link-active") || i.openPage(parseInt(t(this).data("page"))) },
                            openPage: function(e) { i.meta.page = parseInt(e), t(o).trigger(i.paginateEvent, i.meta), i.callback(i, i.meta), t(i.pager).trigger("datatable-on-goto-page", i.meta) },
                            updatePerpage: function(e) { e.preventDefault(), t(this).selectpicker("toggle"), i.pager = t(o.table).siblings(".datatable-pager").removeClass("datatable-paging-loaded"), e.originalEvent && (i.meta.perpage = parseInt(t(this).val())), t(i.pager).find("select.datatable-pager-size").val(i.meta.perpage).attr("data-selected", i.meta.perpage), l.setDataSourceParam("pagination", { page: i.meta.page, pages: i.meta.pages, perpage: i.meta.perpage, total: i.meta.total }), t(i.pager).trigger("datatable-on-update-perpage", i.meta), t(o).trigger(i.paginateEvent, i.meta), i.callback(i, i.meta), i.updateInfo.call() },
                            ...
                            updateInfo: function() {
                                ...
                                t(i.pager).find(".datatable-pager-info").find(".datatable-pager-detail").html(l.dataPlaceholder(l.getOption("translate.toolbar.pagination.items.info"), { start: 0 === i.meta.total ? 0 : e, end: -1 === i.meta.perpage ? i.meta.total : a, pageSize: -1 === i.meta.perpage || i.meta.perpage >= i.meta.total ? i.meta.total : i.meta.perpage, total: i.meta.total }))
                            },
                    ...
                    columnHide: function() {
                        ...
                        t.each(i.columns, (function(n, i) {
                            if (void 0 !== i.responsive || void 0 !== i.visible) {
                                var r = i.field,
                                    s = t.grep(t(o.table).find(".datatable-cell"), (function(e, a) { return r === t(e).data("field") }));
                                setTimeout((function() {!1 === l.getObject("visible", i) ? t(s).hide() : (a.getBreakpoint(l.getObject("responsive.hidden", i)) >= e ? t(s).hide() : t(s).show(), a.getBreakpoint(l.getObject("responsive.visible", i)) <= e ? t(s).show() : t(s).hide()) }))
                            }
                        }))
                    },
                    setupSubDatatable: function() {
                        ...
                        if ("function" == typeof e && !(t(o.table).find(".datatable-subtable").length > 0)) {
                            ...
                            var a = function(a) {
                                    ...
                                    t(n).hasClass("datatable-row-subtable-expanded") ? (t(c).addClass(l.getOption("layout.icons.rowDetail.collapse")), t(n).removeClass("datatable-row-subtable-expanded"), t(o).trigger("datatable-on-collapse-subtable", [n])) : (t(c).addClass(l.getOption("layout.icons.rowDetail.expand")), t(n).addClass("datatable-row-subtable-expanded"), t(o).trigger("datatable-on-expand-subtable", [n])), 0 === t(s).find(".datatable").length && (t.map(o.dataSet, (function(t, e) { return d === t[i.columns[0].field] && (a.data = t, !0) })), a.detailCell = s, a.parentRow = n, a.subTable = s, e(a), t(s).children(".datatable").on("datatable-on-init", (function(e) { t(r).removeClass("datatable-row-loading") })), "local" === l.getOption("data.type") && t(r).removeClass("datatable-row-loading"))
                                },
                                n = i.columns;
                            t(o.tableBody).find(".datatable-row").each((function(e, i) {
                                t(i).find(".datatable-cell").each((function(e, i) {
                                    var o = t.grep(n, (function(e, a) { return t(i).data("field") === e.field }))[0];
                                    if (void 0 !== o) {
                                        var r = t(i).text();
                    ...
                    dataMapCallback: function(t) { var e = t; return "function" == typeof l.getOption("data.source.read.map") ? l.getOption("data.source.read.map")(t) : (void 0 !== t && void 0 !== t.data && (e = t.data), e) },
                    isSpinning: !1,
                    ...
                    sortCallback: function(e, a, n) {
                        ...
                        return t(e).sort((function(n, r) {
                            ...
                            switch (i) {
                                ...
                                case "html":
                                    return t(e).sort((function(e, n) { return s = t(e[l]).text(), d = t(n[l]).text(), "asc" === a ? s > d ? 1 : s < d ? -1 : 0 : s < d ? 1 : s > d ? -1 : 0 }));
                                case "string":
                                default:
                    ...
                    log: function(t, e) { void 0 === e && (e = ""), o.debug && console.log(t, e) },
                    autoHide: function() {
                        var e = !1,
                            ...
                            if (t(n).hasClass("datatable-row-detail")) t(this).find("i").removeClass(l.getOption("layout.icons.rowDetail.expand")).addClass(l.getOption("layout.icons.rowDetail.collapse")), t(n).remove();
                                ...
                                t(o).each((function() {
                                    var e = t(this).data("field"),
                                        a = t.grep(i.columns, (function(t, a) { return e === t.field }))[0];
                        ...
                        setTimeout((function() {
                            ...
                            })), e && t(o.tableBody).find(".datatable-row").each((function() { 0 === t(this).find(".datatable-toggle-detail").length && t(this).prepend(t("<td/>").addClass("datatable-cell datatable-toggle-detail").append(t("<a/>").addClass("datatable-toggle-detail").attr("href", "").on("click", n).append('<i class="' + l.getOption("layout.icons.rowDetail.collapse") + '"></i>'))), 0 === t(o.tableHead).find(".datatable-toggle-detail").length ? (t(o.tableHead).find(".datatable-row").first().prepend('<th class="datatable-cell datatable-toggle-detail"><span></span></th>'), t(o.tableFoot).find(".datatable-row").first().prepend('<th class="datatable-cell datatable-toggle-detail"><span></span></th>')) : t(o.tableHead).find(".datatable-toggle-detail").find("span") }))
                        })), l.adjustCellsWidth.call()
                    },
                    setAutoColumns: function() { l.getOption("data.autoColumns") && (t.each(o.dataSet[0], (function(e, a) { 0 === t.grep(i.columns, (function(t, a) { return e === t.field })).length && i.columns.push({ field: e, title: e }) })), t(o.tableHead).find(".datatable-row").remove(), l.setHeadTitle(), l.getOption("layout.footer") && (t(o.tableFoot).find(".datatable-row").remove(), l.setHeadTitle(o.tableFoot))) },
                    isLocked: function() { var t = l.lockEnabledColumns(); return t.left.length > 0 || t.right.length > 0 },
                    isSubtable: function() { return a.hasClass(o.wrap[0], "datatable-subtable") || !1 },
                    ...
                    getTableId: function(e) { void 0 === e && (e = ""); var a = t(o).attr("id"); return void 0 === a && (a = t(o).attr("class").split(" ")[0]), a + e },
                    getTablePrefix: function(t) { return void 0 !== t && (t = "-" + t), l.getTableId() + "-" + l.getDepth() + t },
                    getDepth: function() {
                        var e = 0,
                            a = o.table;
                        do { a = t(a).parents(".datatable-table"), e++ } while (t(a).length > 0);
                        return e
                    },
                    stateKeep: function(t, e) { t = l.getTablePrefix(t), !1 !== l.getOption("data.saveState") && localStorage && localStorage.setItem(t, JSON.stringify(e)) },
                    stateGet: function(t, e) { if (t = l.getTablePrefix(t), !1 !== l.getOption("data.saveState")) { var a = null; return localStorage && (a = localStorage.getItem(t)), null != a ? JSON.parse(a) : void 0 } },
                    stateUpdate: function(e, a) {
                        var n = l.stateGet(e);
                        null == n && (n = {}), l.stateKeep(e, t.extend({}, n, a))
                    },
                    stateRemove: function(t) { t = l.getTablePrefix(t), localStorage && localStorage.removeItem(t) },
                    getTotalColumns: function(e) { return void 0 === e && (e = o.tableBody), t(e).find(".datatable-row").first().find(".datatable-cell").length },
                    getOneRow: function(e, a, n) { void 0 === n && (n = !0); var i = t(e).find(".datatable-row:not(.datatable-row-detail):nth-child(" + a + ")"); return n && (i = i.find(".datatable-cell")), i },
                    ...
                    sorting: function() {
                        var e = {
                            init: function() { i.sortable && (t(o.tableHead).find(".datatable-cell:not(.datatable-cell-check)").addClass("datatable-cell-sort").off("click").on("click", e.sortClick), e.setIcon()) },
                            setIcon: function() {
                            ...
                            sortClick: function(n) {
                                ...
                                if (void 0 !== d && (void 0 === d.sortable || !1 !== d.sortable) && (void 0 === d.selector || !0 !== d.selector) && (t(o.tableHead).find("th").removeClass("datatable-cell-sorted"), a.addClass(this, "datatable-cell-sorted"), t(o.tableHead).find(".datatable-cell > span > i").remove(), i.sortable)) {
                                    l.spinnerCallback(!0);
                                    var c = "desc";
                                    l.getObject("field", r) === s && (c = l.getObject("sort", r)), r = { field: s, sort: c = void 0 === c || "desc" === c ? "asc" : "desc" }, l.setDataSourceParam("sort", r), e.setIcon(), setTimeout((function() { l.dataRender("sort"), t(o).trigger("datatable-on-sort", r) }), 300)
                                }
                            }
                        };
                        e.init()
                            ...
                            var r = function(t) {
                                    for (var e in t)
                                        if (t.hasOwnProperty(e))
                                            if ("string" == typeof t[e]) { if (t[e].toLowerCase() == s || -1 !== t[e].toLowerCase().indexOf(s)) return !0 } else if ("number" == typeof t[e]) { if (t[e] === s) return !0 } else if ("object" == typeof t[e] && r(t[e])) return !0;
                                    return !1
                                },
                                s = t(l.getOption("search.input")).val();
                            void 0 !== s && "" !== s && (s = s.toLowerCase(), o.dataSet = t.grep(o.dataSet, r), delete e.query[l.getGeneralSearchKey()]), t.each(e.query, (function(t, a) { "" === a && delete e.query[t] })), o.dataSet = l.filterArray(o.dataSet, e.query), o.dataSet = o.dataSet.filter((function() { return !0 }))
                        }
                        return o.dataSet
                    },
                        ...
                        return t.each(e, (function(e, r) {
                            ...
                            t.each(a, (function(t, e) {
                                ...
                                if (void 0 !== a && a) {
                                    ...
                                    e.forEach((function(t, e) { t.toString().toLowerCase() != n && -1 === n.indexOf(t.toString().toLowerCase()) || d++ }))
                                }
                            })), ("AND" == n && d == i || "OR" == n && d > 0 || "NOT" == n && 0 == d) && (o[e] = r)
                        })), e = o
                    },
                    resetScroll: function() { void 0 === i.detail && 1 === l.getDepth() && (t(o.table).find(".datatable-row").css("left", 0), t(o.table).find(".datatable-lock").css("top", 0), t(o.tableBody).scrollTop(0)) },
                    getColumnByField: function(e) { var a; if (void 0 !== e) return t.each(i.columns, (function(t, n) { if (e === n.field) return a = n, !1 })), a },
                    getDefaultSortColumn: function() { var e; return t.each(i.columns, (function(a, n) { if (void 0 !== n.sortable && -1 !== t.inArray(n.sortable, ["asc", "desc"])) return e = { sort: n.sortable, field: n.field }, !1 })), e },
                    getHiddenDimensions: function(e, a) {
                        ...
                        return o.each((function() {
                            ...
                            l.push(t)
                        })), i.width = t(e).width(), i.outerWidth = t(e).outerWidth(a), i.innerWidth = t(e).innerWidth(), i.height = t(e).height(), i.innerHeight = t(e).innerHeight(), i.outerHeight = t(e).outerHeight(a), o.each((function(t) { var e = l[t]; for (var a in n) this.style[a] = e[a] })), i
                    },
                    getGeneralSearchKey: function() { var e = t(l.getOption("search.input")); return l.getOption("search.key") || t(e).prop("name") },
                    ...
                    rowEvenOdd: function() { t(o.tableBody).find(".datatable-row").removeClass("datatable-row-even"), t(o.wrap).hasClass("datatable-subtable") ? t(o.tableBody).find(".datatable-row:not(.datatable-row-detail):even").addClass("datatable-row-even") : t(o.tableBody).find(".datatable-row:nth-child(even)").addClass("datatable-row-even") },
                    timer: 0,
                    redraw: function() { return l.adjustCellsWidth.call(), l.isLocked() && (l.scrollbar(), l.resetScroll(), l.adjustCellsHeight.call()), l.adjustLockContainer.call(), l.initHeight.call(), o },
                    load: function() { return l.reload(), o },
                    reload: function() { return function(t, e) { clearTimeout(l.timer), l.timer = setTimeout(t, e) }((function() { i.data.serverFiltering || l.localDataUpdate(), l.dataRender(), t(o).trigger("datatable-on-reloaded") }), l.getOption("search.delay")), o },
                    getRecord: function(e) { return void 0 === o.tableBody && (o.tableBody = t(o.table).children("tbody")), t(o.tableBody).find(".datatable-cell:first-child").each((function(a, n) { if (e == t(n).text()) { var i = t(n).closest(".datatable-row").index() + 1; return o.API.record = o.API.value = l.getOneRow(o.tableBody, i), o } })), o },
                    getColumn: function(e) { return l.setSelectedRecords(), o.API.value = t(o.API.record).find('[data-field="' + e + '"]'), o },
                    destroy: function() { t(o).parent().find(".datatable-pager").remove(); var e = t(o.initialDatatable).addClass("datatable-destroyed").show(); return t(o).replaceWith(e), t(o = e).trigger("datatable-on-destroy"), l.isInit = !1, e = null, o.dataSet = null, o.originalDataSet = null, o.tableHead = null, o.tableBody = null, o.table = null, o.wrap = null, o.API = { record: null, value: null, params: null }, l.ajaxParams = {}, l.pagingObject = {}, l.nodeTr = [], l.nodeTd = [], l.nodeCols = [], l.recentNode = [], e },
                    sort: function(e, a) { a = void 0 === a ? "asc" : a, l.spinnerCallback(!0); var n = { field: e, sort: a }; return l.setDataSourceParam("sort", n), setTimeout((function() { l.dataRender("sort"), t(o).trigger("datatable-on-sort", n), t(o.tableHead).find(".datatable-cell > span > i").remove() }), 300), o },
                    getValue: function() { return t(o.API.value).text() },
                    ...
                    setSelectedRecords: function() { return o.API.record = t(o.tableBody).find(".datatable-row-active"), o },
                    getSelectedRecords: function() { return l.setSelectedRecords(), o.API.record = o.rows(".datatable-row-active").nodes(), o.API.record },
                    getOption: function(t) { return l.getObject(t, i) },
                    setOption: function(t, e) { i = l.extendObj(i, t, e) },
                    search: function(e, a) {
                        void 0 !== a && (a = t.makeArray(a)), n = function() {
                            ...
                            "object" == typeof a && (t.each(a, (function(t, a) { n[a] = e })), t.each(n, (function(e, a) {
                    ...
                    setDataSourceParam: function(e, a) { o.API.params = t.extend({}, { pagination: { page: 1, perpage: l.getOption("data.pageSize") }, sort: l.getDefaultSortColumn(), query: {} }, o.API.params, l.stateGet(l.stateId)), o.API.params = l.extendObj(o.API.params, e, a), l.stateKeep(l.stateId, o.API.params) },
                    getDataSourceParam: function(e) { return o.API.params = t.extend({}, { pagination: { page: 1, perpage: l.getOption("data.pageSize") }, sort: l.getDefaultSortColumn(), query: {} }, o.API.params, l.stateGet(l.stateId)), "string" == typeof e ? l.getObject(e, o.API.params) : o.API.params },
                    getDataSourceQuery: function() { return l.getDataSourceParam("query") || {} },
                    setDataSourceQuery: function(t) { l.setDataSourceParam("query", t) },
                    getCurrentPage: function() { return t(o.table).siblings(".datatable-pager").last().find(".datatable-pager-nav").find(".datatable-pager-link.datatable-pager-link-active").data("page") || 1 },
                    getPageSize: function() { return t(o.table).siblings(".datatable-pager").last().find("select.datatable-pager-size").val() || 10 },
                    getTotalRows: function() { return o.API.params.pagination.total },
                    getDataSet: function() { return o.originalDataSet },
                    nodeTr: [],
                    nodeTd: [],
                    nodeCols: [],
                    recentNode: [],
                    table: function() { if (void 0 !== o.table) return o.table },
                    row: function(e) { return l.rows(e), l.nodeTr = l.recentNode = t(l.nodeTr).first(), o },
                    rows: function(e) { return l.isLocked() ? l.nodeTr = l.recentNode = t(o.tableBody).find(e).filter(".datatable-lock-scroll > .datatable-row") : l.nodeTr = l.recentNode = t(o.tableBody).find(e).filter(".datatable-row"), o },
                    column: function(e) { return l.nodeCols = l.recentNode = t(o.tableBody).find(".datatable-cell:nth-child(" + (e + 1) + ")"), o },
                    columns: function(e) {
                        var a = o.table;
                    ...
                    cell: function(e) { return l.cells(e), l.nodeTd = l.recentNode = t(l.nodeTd).first(), o },
                    cells: function(e) { var a = t(o.tableBody).find(".datatable-cell"); return void 0 !== e && (a = t(a).filter(e)), l.nodeTd = l.recentNode = a, o },
                    remove: function() { return t(l.nodeTr.length) && l.nodeTr === l.recentNode && t(l.nodeTr).remove(), l.layoutUpdate(), o },
                    visible: function(e) {
                    ...
                    nodes: function() { return l.recentNode },
                    dataset: function() { return o },
                    gotoPage: function(t) { void 0 !== l.pagingObject && (l.isInit = !0, l.pagingObject.openPage(t)) }
                };
                if (t.each(l, (function(t, e) { o[t] = e })), void 0 !== i)
                    if ("string" == typeof i) {
                        var r = i;
    ...
    function(t) {
        t.fn.KTDatatable = t.fn.KTDatatable || {}, t.fn.KTDatatable.checkbox = function(e, a) {
            var n = {
                ...
                unselectedRows: [],
                init: function() {
                    n.selectorEnabled() && (e.setDataSourceParam(a.vars.selectedAllRows, !1), e.stateRemove("checkbox"), a.vars.requestIds && e.setDataSourceParam(a.vars.requestIds, !0), t(e).on("datatable-on-reloaded", (function() { e.stateRemove("checkbox"), e.setDataSourceParam(a.vars.selectedAllRows, !1), n.selectedAllRows = !1, n.selectedRows = [], n.unselectedRows = [] })), n.selectedAllRows = e.getDataSourceParam(a.vars.selectedAllRows), t(e).on("datatable-on-layout-updated", (function(a, i) { i.table == t(e.wrap).attr("id") && e.ready((function() { n.initVars(), n.initEvent(), n.initSelect() })) })), t(e).on("datatable-on-check", (function(t, a) {
                        a.forEach((function(t) { n.selectedRows.push(t), n.unselectedRows = n.remove(n.unselectedRows, t) }));
                        var i = {};
                        ...
                        a.forEach((function(t) { n.unselectedRows.push(t), n.selectedRows = n.remove(n.selectedRows, t) }));
                        var i = {};
                ...
                initEvent: function() {
                    t(e.tableHead).find('.checkbox-all > [type="checkbox"]').click((function(i) {
                        if (n.selectedRows = n.unselectedRows = [], e.stateRemove("checkbox"), n.selectedAllRows = !!t(this).is(":checked"), !a.vars.requestIds) {
                            t(this).is(":checked") && (n.selectedRows = t.makeArray(t(e.tableBody).find('.checkbox-single > [type="checkbox"]').map((function(e, a) { return t(a).val() }))));
                            var o = {};
                ...
                unique: function(t, e, a) { return a.indexOf(t) === e },
...
var KTLayoutAside = function() {
    ...
    return {
        init: function(n) {
            var i;
            (e = KTUtil.getById(n), t = KTUtil.getBody(), e) && (i = KTUtil.hasClass(e, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside", a = new KTOffcanvas(e, { baseClass: i, overlay: !0, closeBy: "kt_aside_close_btn", toggleBy: { target: "kt_aside_mobile_toggle", state: "mobile-toggle-active" } }))
        },
        getElement: function() { return e },
        getOffcanvas: function() { return a },
        isFixed: function() { return KTUtil.hasClass(t, "aside-fixed") },
        isMinimized: function() { return KTUtil.hasClass(t, "aside-fixed") && KTUtil.hasClass(t, "aside-minimize") },
        isHoverable: function() { return KTUtil.hasClass(t, "aside-fixed") && KTUtil.hasClass(t, "aside-minimize-hoverable") }
    }
}();
"undefined" != typeof module && (module.exports = KTLayoutAside);
var KTLayoutBrand = function() { var t; return { init: function(e) { t = KTUtil.getById(e) }, getElement: function() { return t }, getHeight: function() { return e = 0, t && (e = KTUtil.actualHeight(t)), e; var e } } }();
"undefined" != typeof module && (module.exports = KTLayoutBrand);
var KTLayoutContent = function() { var t; return { init: function(e) { t = KTUtil.getById(e) }, getHeight: function() { return e = KTUtil.getViewPort().height, t && (e = e - parseInt(KTUtil.css(t, "paddingTop")) - parseInt(KTUtil.css(t, "paddingBottom"))), e -= KTLayoutHeader.getHeight(), (e -= KTLayoutSubheader.getHeight()) - KTLayoutFooter.getHeight(); var e }, getElement: function() { return t } } }();
"undefined" != typeof module && (module.exports = KTLayoutContent);
var KTLayoutFooter = function() { var t; return { init: function(e) { t = KTUtil.getById(e) }, getHeight: function() { return e = 0, t && (e = KTUtil.actualHeight(t)), e; var e }, getElement: function() { return t } } }();
"undefined" != typeof module && (module.exports = KTLayoutFooter);
var KTLayoutHeaderMenu = function() { var t, e, a, n; return { init: function(i, o) { t = KTUtil.getById(i), a = KTUtil.getById(o), t && (n = new KTOffcanvas(a, { overlay: !0, baseClass: "header-menu-wrapper", closeBy: "kt_header_menu_mobile_close_btn", toggleBy: { target: "kt_header_mobile_toggle", state: "mobile-toggle-active" } }), (e = new KTMenu(t, { submenu: { desktop: "dropdown", tablet: "accordion", mobile: "accordion" }, accordion: { slideSpeed: 200, expandAll: !1 } })).on("linkClick", (function(t) { KTUtil.isBreakpointDown("lg") && n.hide() }))) }, getMenuElement: function() { return t }, getOffcanvasElement: function() { return a }, getMenu: function() { return e }, pauseDropdownHover: function(t) { e && e.pauseDropdownHover(t) }, getOffcanvas: function() { return n }, closeMobileOffcanvas: function() { e && KTUtil.isMobileDevice() && n.hide() } } }();
        ...
        init: function(a) {
            ...
            (t = KTUtil.getById(a)) && (n = 300, void 0 !== KTLayoutHeader && (n = KTLayoutHeader.getHeight()), (e = new KTCard(t, {
                sticky: {
                    ...
                    zIndex: 90,
                    position: {
                        top: function() { var t = 0; return KTUtil.getBody(), KTUtil.isBreakpointUp("lg") ? (void 0 !== KTLayoutHeader && KTLayoutHeader.isFixed() && (t += KTLayoutHeader.getHeight()), void 0 !== KTLayoutSubheader && KTLayoutSubheader.isFixed() && (t += KTLayoutSubheader.getHeight())) : void 0 !== KTLayoutHeader && KTLayoutHeader.isFixedForMobile() && (t += KTLayoutHeader.getHeightForMobile()), t - 1 },
                        left: function(e) { return KTUtil.offset(t).left },
                        right: function(e) {
            ...
            })).initSticky(), KTUtil.addResizeHandler((function() { e.updateSticky() })))
        },
        update: function() { e && e.updateSticky() }
    }
}();
...
var KTLayoutStretchedCard = function() {
    ...
    return {
        init: function(a) {
            (t = KTUtil.getById(a)) && (e(), KTUtil.addResizeHandler((function() { e() })))
        },
        update: function() { e() }
    }
}();
"undefined" != typeof module && (module.exports = KTLayoutStretchedCard);
var KTLayoutSubheader = function() { var t; return { init: function(e) { t = KTUtil.getById(e) }, isFixed: function() { return KTUtil.hasClass(KTUtil.getBody(), "subheader-fixed") }, getElement: function() { return t }, getHeight: function() { return e = 0, t && (e = KTUtil.actualHeight(t)), e; var e } } }();
    ...
    return {
        init: function(a) {
            (t = KTUtil.getById(a)) && (! function() {
                e = new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_demo_panel_close", toggleBy: "kt_demo_panel_toggle" });
        ...
        ! function(t) {
            ...
            if (void 0 === e && (e = document.querySelectorAll(".example:not(.example-compact):not(.example-hover):not(.example-basic)")), e && e.length > 0)
                for (var a = 0; a < e.length; ++a) {
                    ...
                    }).on("success", (function(t) { KTUtil.addClass(t.trigger, "example-copied"), t.clearSelection(), setTimeout((function() { KTUtil.removeClass(t.trigger, "example-copied") }), 2e3) }))
                }
        }(t),
        function(t) {
                ...
                for (var a = 0; a < e.length; ++a) {
                    ...
                    KTUtil.addEvent(i, "click", (function() {
                        var t = this.closest(".example"),
                            ...
                            a = this;
                        KTUtil.hasClass(this, "example-toggled") ? KTUtil.slideUp(e, 300, (function() { KTUtil.removeClass(a, "example-toggled"), KTUtil.removeClass(e, "example-code-on"), KTUtil.hide(e) })) : (KTUtil.addClass(e, "example-code-on"), KTUtil.addClass(this, "example-toggled"), KTUtil.slideDown(e, 300, (function() { KTUtil.show(e) })))
                    })), o && new ClipboardJS(o, {
                        target: function(t) {
                            var e = t.closest(".example"),
                                a = KTUtil.find(e, ".example-code .tab-pane.active");
...
var KTLayoutQuickActions = function() {
    ...
    return {
        init: function(e) {
            var a, n;
            (t = KTUtil.getById(e)) && (a = KTUtil.find(t, ".offcanvas-header"), n = KTUtil.find(t, ".offcanvas-content"), new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_actions_close", toggleBy: "kt_quick_actions_toggle" }), KTUtil.scrollInit(n, { disableForMobile: !0, resetHeightOnDestroy: !0, handleWindowResize: !0, height: function() { var e = parseInt(KTUtil.getViewPort().height); return a && (e -= parseInt(KTUtil.actualHeight(a)), e -= parseInt(KTUtil.css(a, "marginTop")), e -= parseInt(KTUtil.css(a, "marginBottom"))), n && (e -= parseInt(KTUtil.css(n, "marginTop")), e -= parseInt(KTUtil.css(n, "marginBottom"))), e -= parseInt(KTUtil.css(t, "paddingTop")), (e -= parseInt(KTUtil.css(t, "paddingBottom"))) - 2 } }))
        },
        getElement: function() { return t }
    }
}();
    ...
    return {
        init: function(e) {
            (t = KTUtil.getById(e)) && function() {
                new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_cart_close", toggleBy: "kt_quick_cart_toggle" });
...
var KTLayoutQuickPanel = function() {
    ...
    return { init: function(o) { t = KTUtil.getById(o), e = KTUtil.getById("kt_quick_panel_notifications"), a = KTUtil.getById("kt_quick_panel_logs"), n = KTUtil.getById("kt_quick_panel_settings"), new KTOffcanvas(t, { overlay: !0, baseClass: "offcanvas", placement: "right", closeBy: "kt_quick_panel_close", toggleBy: "kt_quick_panel_toggle" }), KTUtil.scrollInit(e, { mobileNativeScroll: !0, resetHeightOnDestroy: !0, handleWindowResize: !0, height: function() { return i() } }), KTUtil.scrollInit(a, { mobileNativeScroll: !0, resetHeightOnDestroy: !0, handleWindowResize: !0, height: function() { return i() } }), KTUtil.scrollInit(n, { mobileNativeScroll: !0, resetHeightOnDestroy: !0, handleWindowResize: !0, height: function() { return i() } }), $(t).find('a[data-toggle="tab"]').on("shown.bs.tab", (function(t) { KTUtil.scrollUpdate(e), KTUtil.scrollUpdate(a), KTUtil.scrollUpdate(n) })) } }
}();
